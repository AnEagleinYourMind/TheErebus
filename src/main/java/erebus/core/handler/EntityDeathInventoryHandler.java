...
public class EntityDeathInventoryHandler {
    ...
    public void onPlayerDrops(PlayerDropsEvent event) {
        ...
        if (event.entityLiving instanceof EntityPlayer && !world.getGameRules()
            ...
            for (OffsetPos offset : offsets) if (world.getBlock(x + offset.x, y + offset.y, z + offset.z)
                .isReplaceable(world, x + offset.x, y + offset.y, z + offset.z)) {
                    x += offset.x;
                    y += offset.y;
                    z += offset.z;
                    break;
            ...
            if (playerFacing == 0) directionMeta = 2;
            if (playerFacing == 1) directionMeta = 5;
            if (playerFacing == 2) directionMeta = 3;
            if (playerFacing == 3) directionMeta = 4;
            ...
            if (tile != null) {
                ...
                for (int i = 0; i < drops.size(); i++) {
                    if (index >= 86 || index >= drops.size()) break;
