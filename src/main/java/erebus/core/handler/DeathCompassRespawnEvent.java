...
public class DeathCompassRespawnEvent {
    ...
    public void onClonePlayer(PlayerEvent.Clone event) {
        if (event.wasDeath) {
            ...
            ErebusExtendedPlayerProperties.get(event.original)
                .saveNBTData(compound);
            ErebusExtendedPlayerProperties.get(event.entityPlayer)
            ...
            stack.getTagCompound()
                .setString("dimName", playerProps.getDimension());
            stack.getTagCompound()
                .setInteger("homeX", playerProps.getXLocation());
            stack.getTagCompound()
                .setInteger("homeZ", playerProps.getZLocation());
