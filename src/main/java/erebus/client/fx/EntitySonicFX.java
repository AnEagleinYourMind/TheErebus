...
public class EntitySonicFX extends EntityFX {
    ...
    @SideOnly(Side.CLIENT)
    public EntitySonicFX(World par1World, double par2, double par4, double par6, double par8, double par10,
        double par12) {
    ...
    public void renderParticle(Tessellator par1Tessellator, float par2, float par3, float par4, float par5, float par6,
        ...
        Minecraft.getMinecraft()
            .getTextureManager()
            .bindTexture(new ResourceLocation("erebus:textures/particle/particles.png"));
