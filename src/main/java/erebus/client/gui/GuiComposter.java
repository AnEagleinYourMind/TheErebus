...
public class GuiComposter extends GuiErebus {
    ...
    private static final ResourceLocation composterGuiTextures = new ResourceLocation(
        "erebus:textures/gui/container/composter.png");
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        fontRendererObj.drawString(
            StatCollector.translateToLocal("container.composter"),
            xSize / 2 - fontRendererObj.getStringWidth(StatCollector.translateToLocal("container.composter")) / 2,
            6,
            colour);
        fontRendererObj
            .drawString(StatCollector.translateToLocal("container.inventory"), xSize - 170, ySize - 93, colour);
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTickTime, int mouseX, int mouseY) {
        ...
        mc.getTextureManager()
            .bindTexture(composterGuiTextures);
