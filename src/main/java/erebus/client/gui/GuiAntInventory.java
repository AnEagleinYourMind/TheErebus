...
public class GuiAntInventory extends GuiErebus {
    ...
    private static final ResourceLocation GUI_ANT_INVENTORY = new ResourceLocation(
        "erebus:textures/gui/container/antGuiTest.png");
    public static Item[] ghostIcon = new Item[] { Items.stone_hoe, Items.shears, Items.bucket, Items.bone,
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        fontRendererObj.drawString(
            StatCollector.translateToLocal("container.antInventory"),
            xSize / 2 - fontRendererObj.getStringWidth(StatCollector.translateToLocal("container.antInventory")) / 2,
            6,
            color);
        fontRendererObj
            .drawString(StatCollector.translateToLocal("container.inventory"), xSize - 170, ySize - 93, color);
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTickTime, int mouseX, int mouseY) {
        ...
        if (antInventory.getStackInSlot(0) != null && antInventory.getStackInSlot(0)
        ...
        if (antInventory.getStackInSlot(0) != null && antInventory.getStackInSlot(0)
            .getItem() instanceof ItemBucket && antInventory.getStackInSlot(1) == null) {
            GL11.glPushMatrix();
            GL11.glEnable(GL11.GL_BLEND);
            GL11.glColor4f(1f, 1f, 1f, 0.2f);
            IIcon iicon1 = stack2.getIconIndex();
        ...
        if (antInventory.getStackInSlot(0) != null && antInventory.getStackInSlot(0)
            .getItem() == Items.bone && antInventory.getStackInSlot(1) == null) {
            GL11.glPushMatrix();
            GL11.glEnable(GL11.GL_BLEND);
            GL11.glColor4f(1f, 1f, 1f, 0.2f);
    ...
    public void updateScreen() {
        ...
        if (mc.theWorld.getWorldTime() % 40 == 0) {
            ...
            iconCountTool++;
            iconCountCrop++;
            if (iconCountTool > 3) iconCountTool = 0;
            if (iconCountCrop > 5) iconCountCrop = 4;
        }
    }
}
