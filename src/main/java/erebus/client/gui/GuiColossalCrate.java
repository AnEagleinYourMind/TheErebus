...
public class GuiColossalCrate extends GuiContainer {
    ...
    private static final ResourceLocation GUI_BAMBOO_CRATE = new ResourceLocation(
        "erebus:textures/gui/container/bambooCollosalCrate.png");
