...
public class GuiPetrifiedChest extends GuiErebus {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(
        "erebus:textures/gui/container/petrifiedContainerBig.png");
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        fontRendererObj.drawString(
            lowerChestInventory.hasCustomInventoryName() ? lowerChestInventory.getInventoryName()
                : StatCollector.translateToLocal(lowerChestInventory.getInventoryName()),
            8,
            6,
            Utils.getColour(255, 255, 255));
        fontRendererObj.drawString(
            upperChestInventory.hasCustomInventoryName() ? upperChestInventory.getInventoryName()
                : StatCollector.translateToLocal(upperChestInventory.getInventoryName()),
            8,
            ySize - 96 + 2,
            Utils.getColour(255, 255, 255));
    }
