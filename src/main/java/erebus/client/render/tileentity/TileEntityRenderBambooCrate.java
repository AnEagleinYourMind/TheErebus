...
public class TileEntityRenderBambooCrate extends TileEntitySpecialRenderer {
    ...
    public static ResourceLocation bambooCrateResource = new ResourceLocation(
        "erebus:textures/special/tiles/bambooCrate.png");

    private final ModelColossalCrate colossalCrateModel = new ModelColossalCrate();
    public static ResourceLocation colossalCrateResource = new ResourceLocation(
        "erebus:textures/special/tiles/colossalCrate.png");
