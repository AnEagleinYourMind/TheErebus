...
public class TileEntityGlowingJarRenderer extends TileEntitySpecialRenderer {
    ...
    private static final ResourceLocation GLOWING_JAR = new ResourceLocation(
        "erebus:textures/special/tiles/glowingJar.png");
    ...
    public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float partialTickTime) {
        if (tile instanceof TileEntityJarOHoney) renderJarOHoney((TileEntityJarOHoney) tile, x, y, z);
