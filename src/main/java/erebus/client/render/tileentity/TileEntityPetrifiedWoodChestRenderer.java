...
public class TileEntityPetrifiedWoodChestRenderer extends TileEntitySpecialRenderer {
    ...
    private static final ResourceLocation RES_NORMAL_DOUBLE = new ResourceLocation(
        "erebus:textures/special/tiles/petrifiedLargechest.png");
    private static final ResourceLocation RES_NORMAL_SINGLE = new ResourceLocation(
        "erebus:textures/special/tiles/petrifiedChest.png");

    private final ModelChest chestModel = new ModelChest();
    private final ModelChest largeChestModel = new ModelLargeChest();

    public void renderTileEntityPetrifiedWoodChestAt(TileEntityPetrifiedWoodChest chest, double x, double y, double z,
        ...
        if (chest.adjacentChestZNeg == null && chest.adjacentChestXNeg == null) {
            ...
            if (i == 2 && chest.adjacentChestXPos != null) GL11.glTranslatef(1.0F, 0.0F, 0.0F);

            if (i == 5 && chest.adjacentChestZPosition != null) GL11.glTranslatef(0.0F, 0.0F, -1.0F);
