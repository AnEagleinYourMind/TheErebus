...
public class WaspDaggerItemRenderer extends Render implements IItemRenderer {
    ...
    public void renderWaspDagger(EntityWaspDagger entityWaspDagger, double x, double y, double z, float rotationYaw,
        ...
        GL11.glRotatef(
            entityWaspDagger.prevRotationYaw
                + (entityWaspDagger.rotationYaw - entityWaspDagger.prevRotationYaw) * partialTickTime
                - 90.0F,
            0.0F,
            1.0F,
            0.0F);
        GL11.glRotatef(
            entityWaspDagger.prevRotationPitch
                + (entityWaspDagger.rotationPitch - entityWaspDagger.prevRotationPitch) * partialTickTime
                - EntityWaspDagger.rotationticks,
            0.0F,
            0.0F,
            1.0F);
        GL11.glScaled(0.4F, 0.4F, 0.4F);
