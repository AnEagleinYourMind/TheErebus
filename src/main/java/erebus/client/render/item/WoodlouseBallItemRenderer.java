...
public class WoodlouseBallItemRenderer extends Render implements IItemRenderer {
    ...
    public void renderWoodlouseBall(EntityWoodlouseBall entityWoodlouseBall, double x, double y, double z,
        float rotationYaw, float partialTickTime) {
        FMLClientHandler.instance()
            .getClient()
            .getTextureManager()
            .bindTexture(texture);
        ...
        GL11.glRotatef(
            entityWoodlouseBall.prevRotationYaw
                + (entityWoodlouseBall.rotationYaw - entityWoodlouseBall.prevRotationYaw) * partialTickTime,
            0.0F,
            1.0F,
            0.0F);
