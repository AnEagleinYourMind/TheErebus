...
public class RenderThrownSand extends Render {
    ...
    public void renderThrownSand(EntityThrownSand entityThrownSand, double x, double y, double z, float yaw,
        ...
        GL11.glRotatef(
            entityThrownSand.prevRotationYaw + (entityThrownSand.rotationYaw - entityThrownSand.prevRotationYaw) * tick
                - 90.0F,
            0.0F,
            1.0F,
            0.0F);
        GL11.glRotatef(
            entityThrownSand.prevRotationPitch
                + (entityThrownSand.rotationPitch - entityThrownSand.prevRotationPitch) * tick
                - EntityThrownSand.rotationticks,
            0.0F,
            0.0F,
            1.0F);
