...
public class RenderMoneySpider extends RenderLiving {
    ...
    private static final ResourceLocation[] TEXTURES = new ResourceLocation[] {
        new ResourceLocation("erebus:textures/entity/moneySpider.png"),
        new ResourceLocation("erebus:textures/entity/moneySpiderEuro.png"),
        new ResourceLocation("erebus:textures/entity/moneySpiderPound.png") };
