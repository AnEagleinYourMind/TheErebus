...
public class RenderJumpingSpider extends RenderLiving {
    ...
    private static final ResourceLocation[] TEXTURES = new ResourceLocation[] {
        new ResourceLocation("erebus:textures/entity/jumpingSpider.png"),
        new ResourceLocation("erebus:textures/entity/jumpingSpiderGreen.png"),
        new ResourceLocation("erebus:textures/entity/jumpingSpiderRed.png") };
