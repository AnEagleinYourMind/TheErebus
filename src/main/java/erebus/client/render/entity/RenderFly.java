...
public class RenderFly extends RenderLiving {
    ...
    public void func_82443_a(EntityFly entityFly, double x, double y, double z, float rotationYaw,
    ...
    protected void func_82444_a(EntityFly entityFly, float par2, float par3, float par4) {
        if (!entityFly.getIsFlyHanging()) GL11.glTranslatef(0.0F, MathHelper.cos(par2 * 0.3F) * 0.1F, 0.0F);
        else GL11.glTranslatef(0.0F, -0.1F, 0.0F);
    ...
    @Override
    public void doRender(EntityLiving entityLiving, double x, double y, double z, float rotationYaw,
        float partialTickTime) {
