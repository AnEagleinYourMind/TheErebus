...
public class RenderErebusLightningBolt extends Render {
    ...
    public void doRender(EntityErebusLightningBolt entity, double x, double y, double z, float rotationYaw,
        ...
        for (int k1 = 0; k1 < 4; ++k1) {
            ...
            for (int j = 0; j < 3; ++j) {
                ...
                for (int i1 = k; i1 >= l; --i1) {
                    ...
                    if (j == 0) d9 *= i1 * 0.1D + 1.0D;

                    double d10 = 0.1D + k1 * 0.2D;

                    if (j == 0) d10 *= (i1 - 1) * 0.1D + 1.0D;

                    for (int j1 = 0; j1 < 5; ++j1) {
                        double d11 = x + 0.5D - d9;
                        double d12 = z + 0.5D - d9;

                        if (j1 == 1 || j1 == 2) d11 += d9 * 2.0D;

                        if (j1 == 2 || j1 == 3) d12 += d9 * 2.0D;

                        double d13 = x + 0.5D - d10;
                        double d14 = z + 0.5D - d10;

                        if (j1 == 1 || j1 == 2) d13 += d10 * 2.0D;

                        if (j1 == 2 || j1 == 3) d14 += d10 * 2.0D;
