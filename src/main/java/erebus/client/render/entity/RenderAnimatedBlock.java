...
public class RenderAnimatedBlock extends RenderLiving {
    ...
    public void renderAnimatedBlock(EntityAnimatedBlock entity, double x, double y, double z, float rotationYaw,
        ...
        if (entity.blockID == ModBlocks.bambooCrate) {
            ...
            if (alpha) GL11.glDisable(GL11.GL_BLEND);
            GL11.glPopMatrix();
        }
        if (alpha) {
            GL11.glBlendFunc(GL11.GL_SRC_ALPHA, GL11.GL_ONE_MINUS_SRC_ALPHA);
    ...
    protected void preRenderCallback(EntityLivingBase entityliving, float scale) {
        ...
        if (entityAnimatedBlock.isClimbing()) GL11.glRotatef(90.0F, -1.0F, 0.0F, 0.0F);
    }
    ...
    protected ResourceLocation getEntityTexture(Entity entity) {
        ...
        String blockPath = animatedblock.blockID.getIcon(0, animatedblock.blockMeta)
            .getIconName();
