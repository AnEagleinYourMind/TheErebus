...
public class RenderChameleonTick extends RenderLiving {
    ...
    public void renderChameleonTick(EntityChameleonTick entity, double x, double y, double z, float rotationYaw,
    ...
    protected ResourceLocation getEntityTexture(Entity entity) {
        ...
        String blockPath = chameleonTick.blockID.getIcon(0, chameleonTick.blockMeta)
            .getIconName();
