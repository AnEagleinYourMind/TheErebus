...
public class ModelSnapper extends ModelBase {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAngle, float entityTickTime, float rotationYaw,
        ...
        jawmain1.rotateAngleX = snapper.getDataWatcher()
            .getWatchableObjectFloat(21);
        jawtip1.rotateAngleX = snapper.getDataWatcher()
            .getWatchableObjectFloat(21);
        jawmain2.rotateAngleX = -snapper.getDataWatcher()
            .getWatchableObjectFloat(21);
        jawtip2.rotateAngleX = -snapper.getDataWatcher()
            .getWatchableObjectFloat(21);
        jawmain3.rotateAngleX = -snapper.getDataWatcher()
            .getWatchableObjectFloat(21);
        jawtip3.rotateAngleX = snapper.getDataWatcher()
            .getWatchableObjectFloat(21);
        jawmain4.rotateAngleX = snapper.getDataWatcher()
            .getWatchableObjectFloat(21);
        jawtip4.rotateAngleX = snapper.getDataWatcher()
            .getWatchableObjectFloat(21);
    }
}
