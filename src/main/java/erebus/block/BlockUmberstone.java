...
public class BlockUmberstone extends Block implements IHasCustomItemBlock {
    ...
    public static final String[] iconPaths = new String[] { "umberstone", "cobbleUmber", "cobbleUmberMossy",
        "cobbleUmberWebbed", "umberstoneBricks", "smoothUmbertile", "smoothUmbertiles" };
    ...
    public void onBlockDestroyedByPlayer(World world, int x, int y, int z, int meta) {
        ...
        if (player != null) player.triggerAchievement(ModAchievements.umberstone);
    }
