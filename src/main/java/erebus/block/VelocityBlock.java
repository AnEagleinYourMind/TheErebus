...
public class VelocityBlock extends Block {
    ...
    public void onEntityCollidedWithBlock(World world, int x, int y, int z, Entity entity) {
        ...
        else if (entity instanceof EntityItem) ((EntityItem) entity).age = 0;
        ...
        if (entity.posY > y + 0.5D) {
            if (factorX[meta] == 0 && Math.abs(x + 0.5D - entity.posX) < 0.5D
                && Math.abs(x + 0.5D - entity.posX) > 0.1D)
                entity.motionX += Math.signum(x + 0.5D - entity.posX)
                    * Math.min(speed, Math.abs(x + 0.5D - entity.posX))
                    / 1.2D;

            if (factorZ[meta] == 0 && Math.abs(z + 0.5D - entity.posZ) < 0.5D
                && Math.abs(z + 0.5D - entity.posZ) > 0.1D)
                entity.motionZ += Math.signum(z + 0.5D - entity.posZ)
                    * Math.min(speed, Math.abs(z + 0.5D - entity.posZ))
                    / 1.2D;
