...
public class BlockTurnip extends BlockCrops {
    ...
    public ArrayList<ItemStack> getDrops(World world, int x, int y, int z, int metadata, int fortune) {
        ...
        for (int n = 0; n < dropAmount + fortune; n++) ret.add(new ItemStack(func_149866_i(), 1, 0));
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        ...
        for (int i = 0; i < iconArray.length; ++i) iconArray[i] = iconRegister.registerIcon("erebus:turnips" + i);
    }
}
