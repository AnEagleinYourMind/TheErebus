...
public class SmallMushroom extends BlockMushroom {
    ...
    private final boolean requires2x2ToGrow;
    ...
    public void func_149853_b(World world, Random rand, int x, int y, int z) {
        if (requires2x2ToGrow) {
            if (isMushroom(world, x + 1, y, z) && isMushroom(world, x + 1, y, z + 1)
                && isMushroom(world, x, y, z + 1)) {
            ...
            } else if (isMushroom(world, x - 1, y, z) && isMushroom(world, x - 1, y, z + 1)
                && isMushroom(world, x, y, z + 1)) {
            ...
            WorldGenGiantMushrooms genGiantMushrooms = new WorldGenGiantMushrooms();
            genGiantMushrooms.setMushroomType(MushroomType.getFromShroom(this));
            if (!genGiantMushrooms.generate(world, rand, x, y, z)) world.setBlock(x, y, z, this);
