...
public class DoubleHeightPlant extends BlockDoublePlant implements IShearable {
    ...
    public ArrayList<ItemStack> getDrops(World world, int x, int y, int z, int meta, int fortune) {
        ...
        if (world.rand.nextInt(8) != 0) return drops;
        ...
        else if ("WaterFlower".equals(name)) drops.add(new ItemStack(this));
        else {
            ItemStack seed = ForgeHooks.getGrassSeed(world);
            if (seed != null) drops.add(seed);
        }
