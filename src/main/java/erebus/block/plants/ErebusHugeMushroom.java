...
public class ErebusHugeMushroom extends BlockHugeMushroom {
    ...
    public IIcon getIcon(int side, int meta) {
        return meta == 10 && side > 1 ? stem
            : meta >= 1 && meta <= 9 && side == 1 ? skin
                : meta >= 1 && meta <= 3 && side == 2 ? skin
                    : meta >= 7 && meta <= 9 && side == 3 ? skin
                        : (meta == 1 || meta == 4 || meta == 7) && side == 4 ? skin
                            : (meta == 3 || meta == 6 || meta == 9) && side == 5 ? skin
                                : meta == 14 ? skin : meta == 15 ? stem : inside;
    }
