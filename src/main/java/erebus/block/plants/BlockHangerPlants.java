...
public class BlockHangerPlants extends BlockBush {
    ...
    public static final String[] iconPaths = new String[] { "hanger0", "hanger1", "hanger2", "hanger3", "hanger4",
        "hangerFruit", "hangerSeed" };

    public static final int dataHanger0 = 0, dataHanger1 = 1, dataHanger2 = 2, dataHanger3 = 3, dataHanger4 = 4,
        dataHangerFruit = 5, dataHangerSeed = 6;
    ...
    public void updateTick(World world, int x, int y, int z, Random rand) {
        ...
        int yy = y - 1;
        // New shoot
        if (world.isAirBlock(x, yy, z) && canBlockStay(world, x, yy, z)) switch (meta) {
            case dataHanger4:
            case dataHangerFruit:
            case dataHangerSeed:
        ...
        // Fruit
        if (meta == dataHanger4 && rand.nextInt(50) == 0) world.setBlock(x, y, z, this, dataHangerFruit, 2);

        // Seeds
        if (meta == dataHangerFruit && rand.nextInt(10) == 0) world.setBlock(x, y, z, this, dataHangerSeed, 2);

        // Revert Seeds
        if (meta == dataHangerSeed && rand.nextInt(10) == 0) world.setBlock(x, y, z, this, dataHanger4, 2);
    }
