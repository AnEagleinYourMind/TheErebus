...
public class BlockSaplingErebus extends BlockSapling {
    ...
    public String getLocalizedName() {
        return StatCollector
            .translateToLocal("tile." + Reference.MOD_ID + ".sapling_" + wood.getUnlocalisedName() + ".name");
    }
    ...
    public void updateTick(World world, int x, int y, int z, Random rand) {
        if (!world.isRemote) {
            ...
            if (rand.nextInt(13 - (world.getBlockLightValue(x, y + 1, z) >> 1)) == 0) growTree(world, x, y, z, rand);
        }
    }
    ...
    private void growTree(World world, int x, int y, int z, Random rand) {
        ...
        if (!worldGen.generate(world, rand, x, y, z)) world.setBlock(x, y, z, this);
    }
}
