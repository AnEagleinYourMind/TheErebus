...
public class BlockTempleBrickUnbreaking extends Block {
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX,
        ...
        if (stack != null) switch (meta) {
            case 0:
                return true;
            case 1:
                if (stack.getItem() == ModItems.materials
                    && stack.getItemDamage() == ItemMaterials.DATA.JADE.ordinal()) {
            ...
            case 2:
                if (stack.getItem() == ModItems.materials
                    && stack.getItemDamage() == ItemMaterials.DATA.PLATE_EXO.ordinal()) {
            ...
            case 4:
                if (stack.getItem() == ModItems.materials
                    && stack.getItemDamage() == ItemMaterials.DATA.MAGMA_CRAWLER_EYE.ordinal()) {
