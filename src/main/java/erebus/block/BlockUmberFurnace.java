...
public class BlockUmberFurnace extends BlockContainer {
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX,
        ...
        if (tile != null) player.openGui(Erebus.instance, CommonProxy.GuiID.UMBER_FURNACE.ordinal(), world, x, y, z);
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase player, ItemStack is) {
        ...
        if (meta == 0) world.setBlockMetadataWithNotify(x, y, z, 2, 2);
        if (meta == 1) world.setBlockMetadataWithNotify(x, y, z, 5, 2);
        if (meta == 2) world.setBlockMetadataWithNotify(x, y, z, 3, 2);
