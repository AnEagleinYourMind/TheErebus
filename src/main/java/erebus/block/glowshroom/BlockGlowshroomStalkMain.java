...
public class BlockGlowshroomStalkMain extends Block {
    ...
    public void updateTick(World world, int x, int y, int z, Random rand) {
        ...
        if (rand.nextInt(10) == 0) if (world.isAirBlock(x, y + 1, z)) world.setBlock(x, y + 1, z, ModBlocks.glowshroom);
    }
    ...
    public void onNeighborBlockChange(World world, int x, int y, int z, Block neighbour) {
        ...
        if (!canPlaceBlockAt(world, x, y, z)) Utils.breakBlockWithParticles(world, x, y, z);
    }
