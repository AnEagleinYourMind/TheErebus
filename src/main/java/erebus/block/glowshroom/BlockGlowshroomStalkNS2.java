...
public class BlockGlowshroomStalkNS2 extends BlockGlowshroomPart {
    ...
    public void updateTick(World world, int x, int y, int z, Random rand) {
        ...
        if (world.getBlock(x, y, z + 1) == ModBlocks.glowshroomStalkMain) {
            ...
            else if (world.getBlock(x, y, z - 1) == ModBlocks.glowshroomStalkN1) return;
            else if (world.getBlock(x, y, z - 1) == ModBlocks.glowshroomStalkN3) return;
            else world.setBlock(x, y, z, ModBlocks.glowshroomStalkMain);
        }

        else if (world.getBlock(x, y, z - 1) == ModBlocks.glowshroomStalkMain)
            if (rand.nextInt(2) == 0 && world.isAirBlock(x, y, z + 1))
                world.setBlock(x, y, z + 1, ModBlocks.glowshroomStalkS1);
            else if (world.getBlock(x, y, z + 1) == ModBlocks.glowshroomStalkS1) return;
            else if (world.getBlock(x, y, z + 1) == ModBlocks.glowshroomStalkS3) return;
            else world.setBlock(x, y, z, ModBlocks.glowshroomStalkMain);
    }
