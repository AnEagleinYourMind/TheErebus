...
public class BlockGlowshroomStalkWE2 extends BlockGlowshroomPart {
    ...
    public void updateTick(World world, int x, int y, int z, Random rand) {
        ...
        if (world.getBlock(x + 1, y, z) == ModBlocks.glowshroomStalkMain) {
            ...
            else if (world.getBlock(x - 1, y, z) == ModBlocks.glowshroomStalkW1) return;
            else if (world.getBlock(x - 1, y, z) == ModBlocks.glowshroomStalkW3) return;
            ...
            else if (world.getBlock(x + 1, y, z) == ModBlocks.glowshroomStalkE1) return;
            else if (world.getBlock(x + 1, y, z) == ModBlocks.glowshroomStalkE3) return;
            else world.setBlock(x, y, z, ModBlocks.glowshroomStalkMain);
    }
