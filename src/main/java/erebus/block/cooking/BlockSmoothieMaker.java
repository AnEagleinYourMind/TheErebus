...
public class BlockSmoothieMaker extends BlockContainer {
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int metadata, float hitX,
        ...
        if (tile != null) player.openGui(Erebus.instance, CommonProxy.GuiID.SMOOTHIE_MAKER.ordinal(), world, x, y, z);
    ...
    public void breakBlock(World world, int x, int y, int z, Block block, int meta) {
        ...
        if (tile != null) for (int i = 0; i < tile.getSizeInventory(); i++) {
            ...
            if (stack != null) Utils.dropStack(world, x, y, z, stack);
        }
