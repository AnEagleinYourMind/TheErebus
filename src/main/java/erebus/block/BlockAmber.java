...
public class BlockAmber extends Block implements IHasCustomItemBlock {
    ...
    private final String[] connectedGlassStr = new String[] { "center", "bottomleft", "bottomright", "topleft",
        "topright", "sidingleft", "sidingright", "sidingbottom", "sidingtop", // 8
    ...
    public boolean shouldSideBeRendered(IBlockAccess world, int x, int y, int z, int side) {
        ...
        return block == this || block == ModBlocks.preservedBlock ? false
    ...
    public IIcon getIcon(IBlockAccess world, int x, int y, int z, int side) {
        ...
        if (meta == 1) {
            ...
            if (side == 0 || side == 1)
                nearby = new boolean[] { isGlass(world, x - 1, y, z), isGlass(world, x + 1, y, z),
                    isGlass(world, x, y, z - 1), isGlass(world, x, y, z + 1), isGlass(world, x - 1, y, z - 1),
                    isGlass(world, x - 1, y, z + 1), isGlass(world, x + 1, y, z - 1), isGlass(world, x + 1, y, z + 1) };
            else if (side == 2) nearby = new boolean[] { isGlass(world, x + 1, y, z), isGlass(world, x - 1, y, z),
                isGlass(world, x, y + 1, z), isGlass(world, x, y - 1, z), isGlass(world, x + 1, y + 1, z),
                isGlass(world, x + 1, y - 1, z), isGlass(world, x - 1, y + 1, z), isGlass(world, x - 1, y - 1, z) };
            else if (side == 3) nearby = new boolean[] { isGlass(world, x - 1, y, z), isGlass(world, x + 1, y, z),
                isGlass(world, x, y + 1, z), isGlass(world, x, y - 1, z), isGlass(world, x - 1, y + 1, z),
                isGlass(world, x - 1, y - 1, z), isGlass(world, x + 1, y + 1, z), isGlass(world, x + 1, y - 1, z) };
            else if (side == 4) nearby = new boolean[] { isGlass(world, x, y, z - 1), isGlass(world, x, y, z + 1),
                isGlass(world, x, y + 1, z), isGlass(world, x, y - 1, z), isGlass(world, x, y + 1, z - 1),
                isGlass(world, x, y - 1, z - 1), isGlass(world, x, y + 1, z + 1), isGlass(world, x, y - 1, z + 1) };
            else if (side == 5) nearby = new boolean[] { isGlass(world, x, y, z + 1), isGlass(world, x, y, z - 1),
                isGlass(world, x, y + 1, z), isGlass(world, x, y - 1, z), isGlass(world, x, y + 1, z + 1),
                isGlass(world, x, y - 1, z + 1), isGlass(world, x, y + 1, z - 1), isGlass(world, x, y - 1, z - 1) };
            else return glassAmber;
