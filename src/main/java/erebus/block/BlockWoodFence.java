...
public class BlockWoodFence extends BlockFence {
    ...
    public boolean canConnectFenceTo(IBlockAccess world, int x, int y, int z) {
        ...
        return super.canConnectFenceTo(world, x, y, z) || block instanceof BlockWoodFence
            || block instanceof BlockWoodFenceGate;
    }

    @Override
    public String getLocalizedName() {
        return StatCollector
            .translateToLocal("tile." + Reference.MOD_ID + ".fence_" + wood.getUnlocalisedName() + ".name");
    }
