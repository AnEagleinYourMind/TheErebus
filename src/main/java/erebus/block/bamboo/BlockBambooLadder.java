...
public class BlockBambooLadder extends BlockContainer {
    ...
    public void onNeighborBlockChange(World world, int x, int y, int z, Block neighbour) {
        ...
        if (i1 == 2 && world.isSideSolid(x, y, z + 1, ForgeDirection.NORTH)) flag = true;

        if (i1 == 3 && world.isSideSolid(x, y, z - 1, ForgeDirection.SOUTH)) flag = true;

        if (i1 == 4 && world.isSideSolid(x + 1, y, z, ForgeDirection.WEST)) flag = true;

        if (i1 == 5 && world.isSideSolid(x - 1, y, z, ForgeDirection.EAST)) flag = true;
