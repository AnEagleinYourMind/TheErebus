...
public class ModMaterials {
    ...
    public static ArmorMaterial armorEXOSKELETON = EnumHelper
        .addArmorMaterial("EXOSKELETON", 11, new int[] { 2, 3, 2, 2 }, 15);
    public static ArmorMaterial armorREINEXOSKELETON = EnumHelper
        .addArmorMaterial("REINEXOSKELETON", 33, new int[] { 3, 8, 6, 3 }, 10);
    public static ArmorMaterial armorREINEXOSPECIAL = EnumHelper
        .addArmorMaterial("REINEXOSPECIAL", 33, new int[] { 3, 8, 6, 3 }, 10);
    ...
    public static ToolMaterial weaponScorpionPincer = EnumHelper
        .addToolMaterial("SCORPIONPINCER", 0, 863, 1.0F, 4.0F, 12);
