...
public class ItemSpawnEggs extends ItemMonsterPlacer {
    ...
    public static Class<? extends EntityLiving> getRandomEntityClass() {
        EggData[] eggs = eggTypes.values()
            .toArray(new EggData[0]);

        Class<? extends EntityLiving> cls = eggs[rand.nextInt(eggs.length)].entityClass;
        while (IBossDisplayData.class.isAssignableFrom(cls)) cls = eggs[rand.nextInt(eggs.length)].entityClass;
    ...
    public String getItemStackDisplayName(ItemStack is) {
        String s = StatCollector.translateToLocal(getUnlocalizedName() + ".name")
            .trim();
        String mob = "";
    ...
    static class EggData {
        ...
        EggData(int id, String entityName, Class<? extends EntityLiving> entityClass, int[] rgbPrimaryColor,
            ...
            this(
                ...
                entityName,
                entityClass,
                rgbPrimaryColor[0] << 16 | rgbPrimaryColor[1] << 8 | rgbPrimaryColor[2],
