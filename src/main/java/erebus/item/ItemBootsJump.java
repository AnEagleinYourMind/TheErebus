...
public class ItemBootsJump extends ItemArmor {
    ...
    public String getArmorTexture(ItemStack is, Entity entity, int slot, String type) {
        if (is.getItem() == ModItems.jumpBoots) return "erebus:textures/models/armor/hopper1.png";
        else return null;
    }
    ...
    public void onEntityJump(LivingJumpEvent e) {
        if (e.entityLiving instanceof EntityPlayer) {
            ...
            if (is != null && is.getItem() == this && !e.entityLiving.isSneaking()) e.entityLiving.motionY += 0.4D;
        }
    }
}
