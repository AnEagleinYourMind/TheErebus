...
public class ItemBlockSlabSimple extends ItemBlockLocalised {
    ...
    public boolean onItemUse(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side,
        ...
        if (stack.stackSize == 0) return false;
            ...
            if (block == field_150939_a && (side == 1 && !flag || side == 0 && flag)) {
                if (world.checkNoEntityCollision(field_150939_a.getCollisionBoundingBoxFromPool(world, x, y, z))
                ...
                return true;
            } else return func_150946_a(stack, player, world, x, y, z, side) ? true
    ...
    public boolean func_150936_a(World world, int x, int y, int z, int side, EntityPlayer player, ItemStack stack) {
        ...
        if (block == field_150939_a && meta == 2) return true;
        else {
            if (side == 0) y--;
            if (side == 1) y++;
            if (side == 2) z--;
