...
public class ModItems {
    ...
    public static final Item heartBerries = new ItemFoodHeartBerries(0, 0F, false)
    ...
    public static final Item lifeBlood = new ItemFoodHeartBerries(0, 0F, false).setUnlocalizedName("erebus.lifeBlood")
        .setTextureName("erebus:life_blood");
    public static final Item turnip = new ItemSeedFood(4, 0.6F, ModBlocks.blockTurnip, Blocks.farmland)
        .setCreativeTab(ModTabs.items)
        .setUnlocalizedName("erebus.turnips")
        .setTextureName("erebus:turnips");
    ...
    public static final Item cabbageSeeds = new ItemSeedFood(4, 0.1F, ModBlocks.blockCabbage, Blocks.farmland)
        .setCreativeTab(ModTabs.items)
        .setUnlocalizedName("erebus.cabbageSeeds")
        .setTextureName("erebus:cabbage_seeds");
    ...
    public static final Item exoskeletonHelmet = new ItemArmorExoskeleton(0).setUnlocalizedName("erebus.helmetExo")
        .setTextureName("erebus:helmet_exo");
    public static final Item exoskeletonBody = new ItemArmorExoskeleton(1).setUnlocalizedName("erebus.chestplateExo")
        .setTextureName("erebus:chestplate_exo");
    public static final Item exoskeletonLegs = new ItemArmorExoskeleton(2).setUnlocalizedName("erebus.leggingsExo")
        .setTextureName("erebus:leggings_exo");
    public static final Item exoskeletonBoots = new ItemArmorExoskeleton(3).setUnlocalizedName("erebus.bootsExo")
        .setTextureName("erebus:boots_exo");

    public static final Item reinExoskeletonHelmet = new ItemArmorReinExoskeleton(0)
        .setUnlocalizedName("erebus.exoHelmetRein")
        .setTextureName("erebus:exo_helmet_rein");
    public static final Item reinExoskeletonBody = new ItemArmorReinExoskeleton(1)
        .setUnlocalizedName("erebus.exoChestplateRein")
        .setTextureName("erebus:exo_chestplate_rein");
    public static final Item reinExoskeletonLegs = new ItemArmorReinExoskeleton(2)
        .setUnlocalizedName("erebus.exoLeggingsRein")
        .setTextureName("erebus:exo_leggings_rein");
    public static final Item reinExoskeletonBoots = new ItemArmorReinExoskeleton(3)
        .setUnlocalizedName("erebus.exoBootsRein")
        .setTextureName("erebus:exo_boots_rein");

    // MISC WEAPONS
    public static final Item cavemanClub = new ItemCavemanClub().setFull3D()
        .setUnlocalizedName("erebus.clubBone")
        .setTextureName("erebus:club_bone");
    ...
    public static final Item witherWebSlinger = new ItemWitherWebSlinger()
        .setUnlocalizedName("erebus.witherWebSlinger");
    public static final Item blockExtractor = new ItemExtractor().setFull3D()
        .setUnlocalizedName("erebus.blockExtractor")
        .setTextureName("erebus:block_extractor");
    ...
    // MISC ARMOR
    public static final Item reinCompoundGoggles = new ItemCompoundGoggles(ModMaterials.armorREINEXOSKELETON, 2, 0)
        .setUnlocalizedName("erebus.reinCompoundGoggles")
        .setTextureName("erebus:rein_compound_goggles");
    public static final Item compoundGoggles = new ItemCompoundGoggles(ModMaterials.armorEXOSKELETON, 2, 0)
        .setUnlocalizedName("erebus.compoundGoggles")
        .setTextureName("erebus:compound_goggles");
    public static final Item sprintLeggings = new ItemLeggingsSprint(ModMaterials.armorREINEXOSPECIAL, 2)
        .setUnlocalizedName("erebus.sprintLeggings")
        .setTextureName("erebus:sprint_leggings");
    public static final Item jumpBoots = new ItemBootsJump(ModMaterials.armorREINEXOSPECIAL, 3)
        .setUnlocalizedName("erebus.jumpBoots")
        .setTextureName("erebus:jump_boots");
    public static final Item armorGlider = new ItemArmorGlider().setUnlocalizedName("erebus.armorGlider")
        .setTextureName("erebus:armor_glider");
    public static final ItemArmor armorGliderPowered = (ItemArmor) new ItemArmorGlider()
        .setUnlocalizedName("erebus.armorGliderPowered")
        .setTextureName("erebus:armor_glider_powered");
    public static final Item mushroomHelm = new ItemHelmMushroom(0).setUnlocalizedName("erebus.mushroomHelm")
        .setTextureName("erebus:mushroom_helm");
    public static final Item spiderTShirt = new ItemTShirtSpider(1).setUnlocalizedName("erebus.spiderTShirt")
        .setTextureName("erebus:spider_tshirt");
    public static final Item waterStriders = new ItemArmorWaterStriders(ModMaterials.armorREINEXOSPECIAL, 3)
        .setUnlocalizedName("erebus.waterStriders")
        .setTextureName("erebus:water_striders");
    public static final Item rhinoExoskeletonHelmet = new ItemHelmRhino(0).setUnlocalizedName("erebus.rhinoHelmet")
        .setTextureName("erebus:rhino_helm");
    public static final Item rhinoExoskeletonBody = new ItemArmorRhino(1).setUnlocalizedName("erebus.rhinoChestplate")
        .setTextureName("erebus:rhino_chestplate");
    public static final Item rhinoExoskeletonLegs = new ItemArmorRhino(2).setUnlocalizedName("erebus.rhinoLeggings")
        .setTextureName("erebus:rhino_leggings");
    public static final Item rhinoExoskeletonBoots = new ItemArmorRhino(3).setUnlocalizedName("erebus.rhinoBoots")
        .setTextureName("erebus:rhino_boots");
    ...
    public static final Item bambucketWater = new ItemBambucket(Blocks.flowing_water)
        .setUnlocalizedName("erebus.bambucketWater")
        .setTextureName("erebus:bambucket_water");
    public static final Item bambucketHoney = new ItemBambucket(ModBlocks.honeyBlock)
        .setUnlocalizedName("erebus.bambucketHoney")
        .setTextureName("erebus:bambucket_honey");
    ...
    public static final Item bucketAntiVenom = new ItemBucketAntiVenom().setUnlocalizedName("erebus.bucketAntiVenom")
        .setTextureName("erebus:bucket_antivenom");
    public static final Item bucketBeetleJuice = new ItemBucketOfBeetleJuice()
        .setUnlocalizedName("erebus.bucketBeetleJuice")
        .setTextureName("erebus:bucket_beetle_juice");
    public static final Item bucketHoney = new ItemBucket(ModBlocks.honeyBlock).setMaxStackSize(1)
        .setContainerItem(Items.bucket)
        .setCreativeTab(ModTabs.gears)
        .setUnlocalizedName("erebus.bucketHoney")
        .setTextureName("erebus:bucket_honey");
    ...
    private static void registerProperties() {
        GameRegistry.registerFuelHandler(new IFuelHandler() {
            ...
            public int getBurnTime(ItemStack fuel) {
                if (fuel.getItem() == materials && fuel.getItemDamage() == DATA.BAMBOO.ordinal()) return 300;
                return 0;
            }
        });
    }
