...
public class WorldGenErebusTrees extends WorldGenerator { // TODO
                ...
                for (int var10 = x - var9; var10 <= x + var9 && var7; ++var10)
                    for (var11 = z - var9; var11 <= z + var9 && var7; ++var11) if (var8 >= 0 && var8 < 256) {
                        ...
                        if (!block.isLeaves(world, var10, var8, var11) && block != Blocks.grass
                            && block != Blocks.dirt
                            && !block.isWood(world, var10, var8, var11)) var7 = false;
                    } else var7 = false;
            }
            ...
            if (!var7) return false;
                ...
                if ((block == Blocks.grass || block == Blocks.dirt) && y < 256 - var6 - 1) {
                            ...
                            for (int var16 = z - var13; var16 <= z + var13; ++var16) {
                                ...
                                if ((Math.abs(var15) != var13 || Math.abs(var17) != var13
                                    ...
                                    && (block.getMaterial() == Material.air
                                        || block.canBeReplacedByLeaves(world, var14, var11, var16)))
                    ...
                    if (vinesGrow) {
                        ...
                        if (rand.nextInt(5) == 0 && var6 > 5) for (var11 = 0; var11 < 2; ++var11)
                            for (var12 = 0; var12 < 4; ++var12) if (rand.nextInt(4 - var11) == 0) {
                                var13 = rand.nextInt(3);
                                world.setBlock(
                                    x + Direction.offsetX[ForgeDirection.OPPOSITES[var12]],
                                    y + var6 - 5 + var11,
                                    z + Direction.offsetZ[ForgeDirection.OPPOSITES[var12]],
                                    Blocks.cocoa,
                                    var13 << 2 | var12,
                                    2);
                            }
    ...
    private void growVines(World world, int x, int y, int z, int flags) {
        ...
        while (true) {
            ...
            if (!world.isAirBlock(x, y, z) || var6 <= 0) return;
