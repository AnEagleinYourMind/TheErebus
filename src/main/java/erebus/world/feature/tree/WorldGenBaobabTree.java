...
public class WorldGenBaobabTree extends WorldGenTreeBase {
    ...
    public boolean generate(World world, Random rand, int x, int y, int z) {
        ...
        for (int xx = x - maxRadius; xx <= x + maxRadius; xx++) for (int zz = z - maxRadius; zz <= z + maxRadius; zz++)
            for (int yy = y + 1; yy < y + maxHeight; yy++) if (!world.isAirBlock(xx, yy, zz)) return false;
    ...
    private void createBranch(World world, Random rand, int x, int y, int z, int dir) {
        ...
        for (int i = 0; i <= branchLength; ++i) {
            ...
            if (dir == 1) {
                ...
                if (i == branchLength) createLeaves(world, rand, x + i, y + 1, z, branchLength);
            }
            ...
            if (dir == 3) {
                ...
                if (i == branchLength) createLeaves(world, rand, x, y + 1, z + i, branchLength);
            }
