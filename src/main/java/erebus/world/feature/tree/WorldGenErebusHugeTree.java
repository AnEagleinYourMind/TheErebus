    ...
    public boolean generate(World world, Random rand, int x, int y, int z) {
        ...
        if (y >= 1 && y + height + 1 <= 256) {
            ...
            for (var8 = y; var8 <= y + 1 + height; ++var8) {
                ...
                if (var8 >= y + 1 + height - 2) var9 = 2;

                for (var10 = x - var9; var10 <= x + var9 && var7; ++var10)
                    for (var11 = z - var9; var11 <= z + var9 && var7; ++var11) if (var8 >= 0 && var8 < 256) {
                        block = world.getBlock(var10, var8, var11);
                        if (!block.isLeaves(world, var10, var8, var11) && block != Blocks.grass
                            && block != Blocks.dirt
                            && !block.isWood(world, var10, var8, var11)
                            && !block.isReplaceable(world, var10, var8, var11)) var7 = false;
                    } else var7 = false;
            }
            ...
            if (!var7) return false;
                ...
                if ((block == Blocks.grass || block == Blocks.dirt) && y < 256 - height - 1) {
                    ...
                    for (int var14 = y + height - 2 - rand.nextInt(4); var14
                        > y + height / 2; var14 -= 2 + rand.nextInt(4)) {
                    ...
                    for (var10 = 0; var10 < height; ++var10) {
                        ...
                        if (var10 < height - 1) {
                            ...
                            if (block.isReplaceable(world, x + 1, y + var10, z)
                                || block.isLeaves(world, x + 1, y + var10, z)) {
                            ...
                            if (block.isReplaceable(world, x + 1, y + var10, z + 1)
                                || block.isLeaves(world, x + 1, y + var10, z + 1)) {
                            ...
                            if (block.isReplaceable(world, x, y + var10, z + 1)
                                || block.isLeaves(world, x, y + var10, z + 1)) {
