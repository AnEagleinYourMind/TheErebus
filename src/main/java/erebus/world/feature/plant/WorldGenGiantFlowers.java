...
public class WorldGenGiantFlowers extends WorldGenerator {
    ...
    public boolean generate(World world, Random rand, int x, int y, int z) {
        ...
        if (secondaryPetalColor == -1)
            secondaryPetalColor = petalShape.canHaveSecondaryColor && rand.nextInt(8) == 0 ? rand.nextInt(13)
                : primaryPetalColor;

        // CHECK AIR

        for (int yy = y + 2; yy <= y + stemHeight; yy++) if (!world.isAirBlock(x, yy, z)) return false;

        for (int xx = x - stemShape.rad; xx <= x + stemShape.rad; xx++)
            for (int zz = z - stemShape.rad; zz <= z + stemShape.rad; zz++) {
                for (int yy = y; yy <= y + stemShape.height; yy++) if (!world.isAirBlock(xx, yy, zz)) return false;
        ...
        switch (stemShape) {
            ...
            case SMALL_PLUS:
                for (int a = 0; a < 4; a++) world
                    .setBlock(x + Direction.offsetX[a], y, z + Direction.offsetZ[a], ModBlocks.erebusFlower, 15, 2);
                break;

            case LARGE_PLUS:
                for (int a = 0; a < 4; a++) {
                    world.setBlock(
                        x + Direction.offsetX[a] * 2,
                        y,
                        z + Direction.offsetZ[a] * 2,
                        ModBlocks.erebusFlower,
                        15,
                        2);
                    world.setBlock(
        ...
        switch (petalShape) {
            case DENSE_HEMISPHERE:
                ...
                for (int a = 0; a < 4; a++) {
                    ...
                    world.setBlock(
                        ...
                        15,
                        2);
                    if (rand.nextInt(3) == 0) world.setBlock(
                        x + Direction.offsetX[a] * 3,
                        y + 2,
                        z + Direction.offsetZ[a] * 3,
                        ModBlocks.erebusFlower,
                        15,
                        2);
                }
                ...
                if (rand.nextInt(10) == 0) world.setBlock(x, y + 3, z, ModBlocks.erebusFlower, 14, 2);
                else world.setBlock(x, y + 3, z, ModBlocks.stiga, primaryPetalColor, 2);
                ...
                for (int a = 0; a < 2; a++) for (int b = 0; b < 2; b++) if (petalFormation) {
                    ...
                    world.setBlock(
                        x + Direction.offsetX[a * 2 + b] * 3,
                        y + 4,
                        z + Direction.offsetZ[a * 2 + b] * 3,
                        ModBlocks.erebusFlower,
                        primaryPetalColor,
                        2);
                }
            ...
            case DISPERSE_HEMISPHERE:
                ...
                if (rand.nextInt(10) == 0) world.setBlock(x, y + 1, z, ModBlocks.erebusFlower, 14, 2);
                else world.setBlock(x, y + 1, z, ModBlocks.stiga, primaryPetalColor, 2);

                for (int a = 0; a < 4; a++) for (int b = 1; b <= 3; b++) world.setBlock(
                    x + Direction.offsetX[a] * b,
                    y + b - 1,
                    z + Direction.offsetZ[a] * b,
                    ModBlocks.erebusFlower,
                    secondaryPetalColor,
                    2);
            ...
            case UMBRELLA:
                ...
                if (rand.nextInt(10) == 0) world.setBlock(x, y + 2, z, ModBlocks.erebusFlower, 14, 2);
                else world.setBlock(x, y + 2, z, ModBlocks.stiga, primaryPetalColor, 2);
                ...
                for (int a = 0; a < 2; a++) for (int b = 0; b < 2; b++) {
                    ...
                    world.setBlock(
                        x - 3 + a * 6,
                        y + (reversedUmbrella ? 2 : 0),
                        z - 3 + b * 6,
                        ModBlocks.erebusFlower,
                        secondaryPetalColor,
                        2);
                    world.setBlock(
                        x + Direction.offsetX[a * 2 + b] * 4,
                        y + (reversedUmbrella ? 2 : 0),
                        z + Direction.offsetZ[a * 2 + b] * 4,
                        ModBlocks.erebusFlower,
                        primaryPetalColor,
                        2);
                }
