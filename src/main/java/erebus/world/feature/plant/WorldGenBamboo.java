...
public class WorldGenBamboo extends WorldGenerator {
    ...
    public boolean generate(World world, Random rand, int x, int y, int z) {
        if (checkForWater) {
            ...
            for (int waterAttempt = 0; waterAttempt < 40; waterAttempt++) if (world
                .getBlock(
                    x + rand.nextInt(8) - rand.nextInt(8),
                    y + rand.nextInt(3) - rand.nextInt(6),
                    z + rand.nextInt(8) - rand.nextInt(8))
        ...
        for (int xx, yy, zz, attempt = 0, bambooPlaced = 0; attempt < bambooAmount * 2
            && bambooPlaced < bambooAmount; attempt++) {
