...
public final class OreSettings {
    ...
    private static final byte[] checkX = new byte[] { -1, -1, 1, 1, 0, 0 }, checkY = new byte[] { 0, 0, 0, 0, -1, 1 },
    ...
    public void generate(World world, Random rand, int x, int z) {
        ...
        for (int iteration = 0, attempt, xx, yy, zz, testX, testY, testZ, oreAmount, a; iteration
            < iterations; iteration++) for (attempt = 0; attempt < 12; attempt++) {
    ...
    public static enum OreType {
        ...
        public void setupDefault(OreSettings settings, boolean extraOres) {
            ...
            switch (this) {
                case COAL:
                    settings.setIterations(extraOres ? 6 : 8)
                        .setOreAmount(9, 12);
                    break;
                case IRON:
                    settings.setIterations(extraOres ? 7 : 9, extraOres ? 8 : 10)
                        .setOreAmount(6, 10);
                    break;
                case GOLD:
                    settings.setIterations(extraOres ? 4 : 5)
                        .setOreAmount(6);
                    break;
                case LAPIS:
                    settings.setIterations(3)
                        .setOreAmount(5)
                        .setCheckArea(2);
                    break;
                case EMERALD:
                    settings.setChance(0.33F)
                        .setIterations(0, 2)
                        .setOreAmount(3)
                        .setCheckArea(1);
                    break;
                case DIAMOND:
                    settings.setChance(0.66F)
                        .setIterations(2, 4)
                        .setOreAmount(1)
                        .setCheckArea(1);
                    break;
                case DIAMOND_ENCRUSTED:
                    ...
                    break;
                case JADE:
                    settings.setChance(0.5F)
                        .setIterations(1, 4)
                        .setOreAmount(4)
                        .setCheckArea(2);
                    break;
                case PETRIFIED_WOOD:
                    settings.setIterations(extraOres ? 1 : 2, extraOres ? 3 : 4)
                        .setOreAmount(7, 9)
                        .setCheckArea(2);
                    break;
                case FOSSIL:
                    settings.setChance(0.25F)
                        .setIterations(1, 2)
                        .setOreAmount(8, 11)
                        .setY(36, 112);
                    break;
                case ALUMINIUM:
                    settings.setChance(1F)
                        .setIterations(2, 3)
                        .setOreAmount(3, 4)
                        .setCheckArea(2);
                    break;
