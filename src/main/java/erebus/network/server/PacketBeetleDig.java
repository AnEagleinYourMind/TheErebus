    ...
    protected void handle(World world, EntityPlayerMP player) {
        if (player.isRiding() && player.ridingEntity instanceof EntityStagBeetle) {
            ...
            if (!world.isAirBlock(blockX, blockY, blockZ)) {
                ...
                if (blockY + 0.5D > player.posY + 2) beetle.getDataWatcher()
                    .updateObject(28, (byte) 2);
                else if (blockY + 0.5D < player.posY) beetle.getDataWatcher()
                    .updateObject(28, (byte) 0);
                else beetle.getDataWatcher()
                    .updateObject(28, (byte) 1);
