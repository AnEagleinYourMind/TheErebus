    ...
    protected void handle(World world, EntityClientPlayerMP player) {
        ...
        switch (ParticleType.values[particleType]) {
            case BEETLE_LARVA_SQUISH:
                for (int count = 0; count <= 200; ++count) eff.addEffect(
                    new EntityBreakingFX(
                        player.worldObj,
                        e.posX + (player.worldObj.rand.nextDouble() - 0.5D) * e.width,
                        e.posY + player.worldObj.rand.nextDouble() * e.height - e.yOffset,
                        e.posZ + (player.worldObj.rand.nextDouble() - 0.5D) * e.width,
                        Items.slime_ball));
                break;
            case CRUSHROOM_BLAM:
                for (int a = 0; a < 360; a += 4) {
                    ...
                    eff.addEffect(
                        new EntityRepellentFX(
                            player.worldObj,
                            e.posX + -MathHelper.sin((float) ang) * 3,
                            e.posY + 0.1D,
                            e.posZ + MathHelper.cos((float) ang) * 3,
                            0,
                            0,
                            0));
                }
                ...
                for (int a = 0; a < 360; a += 4) {
                    ...
                    eff.addEffect(
                        new EntityCloudFX(
                            ...
                            e.posY,
                            e.posZ + MathHelper.cos((float) ang) * 3,
                            -MathHelper.sin((float) ang) * 0.5,
                            0.1D,
                            MathHelper.cos((float) ang) * 0.5));
                }
                break;
            case ANTLION_BLAM:
                for (int a = 0; a < 360; a += 4) {
                    double ang = a * Math.PI / 180D;
                    for (int count = 0; count <= 20; ++count) eff.addEffect(
                        new EntityDiggingFX(
                            player.worldObj,
                            e.posX + -MathHelper.sin((float) ang) * 3.5D,
                            e.posY + 0.5D,
                            e.posZ + MathHelper.cos((float) ang) * 3.5D,
                            -MathHelper.sin((float) ang) * 0.8,
                            0.0D,
                            MathHelper.cos((float) ang) * 0.8,
                            ModBlocks.ghostSand,
                            0));
                    eff.addEffect(
                        new EntityCloudFX(
                            player.worldObj,
                            e.posX + -MathHelper.sin((float) ang) * 4.5,
                            e.posY,
                            e.posZ + MathHelper.cos((float) ang) * 4.5,
                            -MathHelper.sin((float) ang) * 1,
                            0.1D,
                            MathHelper.cos((float) ang) * 1));
                }
                break;
            case BOSS_DEATH:
            ...
            case HAMMER_BLAM:
                for (int a = 0; a < 360; a += 4) {
                    double ang = a * Math.PI / 180D;
                    for (int count = 0; count <= 4; ++count) eff.addEffect(
                        new EntityFireworkSparkFX(
                            player.worldObj,
                            e.posX + -MathHelper.sin((float) ang) * 1 * count * 0.5,
                            e.posY - 1,
                            e.posZ + MathHelper.cos((float) ang) * 1 * count * 0.5,
                            -MathHelper.sin((float) ang) * 0.5,
                            0.01D,
                            MathHelper.cos((float) ang) * 0.5,
                            eff));
                    eff.addEffect(
                        new EntityCloudFX(
                            player.worldObj,
                            e.posX + -MathHelper.sin((float) ang) * 2,
                            e.posY - 1,
                            e.posZ + MathHelper.cos((float) ang) * 2,
                            -MathHelper.sin((float) ang) * 0.5,
                            0.01D,
                            MathHelper.cos((float) ang) * 0.5));
                }
