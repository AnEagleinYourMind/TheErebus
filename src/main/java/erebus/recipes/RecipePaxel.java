...
public class RecipePaxel extends ShapedOreRecipe {
    ...
    public RecipePaxel() {
        super(
            ...
            " w ",
            'x',
            new ItemStack(ModItems.jadeAxe, 1, wildcard),
            'y',
            new ItemStack(ModItems.jadeShovel, 1, wildcard),
            'z',
            new ItemStack(ModItems.jadePickaxe, 1, wildcard),
            'w',
            "stickWood");
    }
    ...
    public ItemStack getCraftingResult(InventoryCrafting matrix) {
        ...
        return new ItemStack(
            ModItems.jadePaxel,
            1,
            ModMaterials.toolJADEPAXEL.getMaxUses() - (int) Math
                .floor((float) currentDurability * ModMaterials.toolJADEPAXEL.getMaxUses() / totalDurability));
    }
}
