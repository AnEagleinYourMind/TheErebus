...
public class RecipeHandler {
    ...
    public static void init() {
        ...
        RecipeSorter
            .register("erebus.gliderdye", RecipeGliderDye.class, Category.SHAPELESS, "after:minecraft:shapeless");
        RecipeSorter.register("erebus.paxelrecipe", RecipePaxel.class, Category.SHAPELESS, "after:minecraft:shapeless");
        RecipeSorter.register(
            "erebus.enchantmentsensitiverecipe",
            EnchantSensitiveRecipe.class,
            Category.SHAPED,
            "after:minecraft:shaped");
        RecipeSorter.register(
            "erebus.sprintleggingsupgrades",
            RecipeSprintLeggingsUpgrades.class,
            Category.SHAPELESS,
    ...
    private static void registerRecipes() {
        ...
        // Umber stuff
        addShapedRecipe(
            new ItemStack(ModBlocks.umberPaver, 4, 0),
            "##",
            "##",
            '#',
            new ItemStack(ModBlocks.umberstone, 1, 1));
        addShapedRecipe(
            new ItemStack(ModBlocks.umberPaver, 4, 1),
            "##",
            "##",
            '#',
            new ItemStack(ModBlocks.umberstone, 1, 2));
        addShapedRecipe(
            new ItemStack(ModBlocks.umberPaver, 4, 2),
            "##",
            "##",
            '#',
            new ItemStack(ModBlocks.umberstone, 1, 3));
        addShapedRecipe(
            new ItemStack(ModBlocks.umberFurnace, 1),
            "###",
            "#$#",
            "###",
            '#',
        ...
        addShapedRecipe(
            new ItemStack(ModBlocks.umberstone, 4, 6),
            "##",
            "##",
            '#',
            new ItemStack(ModBlocks.umberstone, 1, 5));
        addShapedRecipe(new ItemStack(ModBlocks.umberstonePillar, 2), "#", "#", '#', "stoneUmber");

        // Petrified Wood stuffs
        addShapedRecipe(
            new ItemStack(ModBlocks.petrifiedWoodPlanks),
            "xx",
            "xx",
            'x',
            ItemMaterials.DATA.PETRIFIED_WOOD.makeStack());
        addShapedRecipe(
            new ItemStack(ModBlocks.petrifiedCraftingTable),
            "xx",
            "xx",
            'x',
            ModBlocks.petrifiedWoodPlanks);
        addShapedRecipe(
            new ItemStack(ModBlocks.petrifiedWoodChest),
            "xxx",
            "xyx",
            "xxx",
            'x',
        ...
        // Stairs, slabs, walls
        for (int i = 0; i < ModBlocks.umbercobbleStairs.length; i++) addShapedRecipe(
            new ItemStack(ModBlocks.umbercobbleStairs[i], 4),
            "#  ",
            "## ",
            "###",
            '#',
            new ItemStack(ModBlocks.umberstone, 1, i));
        addShapedRecipe(
            new ItemStack(ModBlocks.amberBrickStairs, 4),
            "#  ",
            "## ",
            "###",
            '#',
            new ItemStack(ModBlocks.amber, 1, 2));
        addShapedRecipe(
            new ItemStack(ModBlocks.petrifiedWoodStairs, 4),
            "#  ",
            "## ",
            "###",
            '#',
            new ItemStack(ModBlocks.petrifiedWoodPlanks, 1, 0));

        for (Block slab : ModBlocks.stoneSlabs) addShapedRecipe(
            new ItemStack(slab, 6),
            "xxx",
            'x',
            new ItemStack(((BlockSlabStone) slab).base, 1, ((BlockSlabStone) slab).meta));
        for (int i = 0; i < ModBlocks.gneissStairs.length; i++) addShapedRecipe(
            new ItemStack(ModBlocks.gneissStairs[i], 4),
            "#  ",
            "## ",
            "###",
            '#',
            new ItemStack(ModBlocks.gneiss, 1, i));

        addShapedRecipe(new ItemStack(ModBlocks.wall, 6), "###", "###", '#', "stoneUmber");
        addShapedRecipe(
            new ItemStack(ModBlocks.wall, 6, 1),
            "###",
            "###",
            '#',
            new ItemStack(ModBlocks.umberstone, 1, 1));
        addShapedRecipe(
            new ItemStack(ModBlocks.wall, 6, 2),
            "###",
            "###",
            '#',
            new ItemStack(ModBlocks.umberstone, 1, 2));
        addShapedRecipe(
            new ItemStack(ModBlocks.wall, 6, 3),
            "###",
            "###",
            '#',
            new ItemStack(ModBlocks.umberstone, 1, 3));
        addShapedRecipe(
            new ItemStack(ModBlocks.wall, 6, 4),
            "###",
            "###",
            '#',
            new ItemStack(ModBlocks.umberstone, 1, 4));
        addShapedRecipe(
            new ItemStack(ModBlocks.wall, 6, 5),
            "###",
            "###",
            '#',
            new ItemStack(ModBlocks.umberPaver, 1, 0));
        addShapedRecipe(
            new ItemStack(ModBlocks.wall, 6, 6),
            "###",
            "###",
            '#',
            new ItemStack(ModBlocks.umberPaver, 1, 1));
        addShapedRecipe(
            new ItemStack(ModBlocks.wall, 6, 7),
            "###",
            "###",
            '#',
            new ItemStack(ModBlocks.umberPaver, 1, 2));
        addShapedRecipe(new ItemStack(ModBlocks.wall, 6, 8), "###", "###", '#', new ItemStack(ModBlocks.amber, 1, 2));

        // Doors
        addShapedRecipe(
            new ItemStack(ModItems.doorAmber, 3),
            "##",
            "##",
            "##",
            '#',
        ...
        addShapedRecipe(
            new ItemStack(ModItems.doorEucalyptus, 3),
            "##",
            "##",
            "##",
            '#',
            "plank" + EnumWood.Eucalyptus);
        ...
        // Exoskeleton armor
        addShapedRecipe(
            new ItemStack(ModItems.exoskeletonHelmet, 1),
            "sss",
            "s s",
            's',
            ItemMaterials.DATA.PLATE_EXO.makeStack());
        addShapedRecipe(
            new ItemStack(ModItems.exoskeletonBody, 1),
            "s s",
            "sss",
            "sss",
            's',
            ItemMaterials.DATA.PLATE_EXO.makeStack());
        addShapedRecipe(
            new ItemStack(ModItems.exoskeletonLegs, 1),
            "sss",
            "s s",
            "s s",
            's',
            ItemMaterials.DATA.PLATE_EXO.makeStack());
        addShapedRecipe(
            new ItemStack(ModItems.exoskeletonBoots, 1),
            "s s",
            "s s",
            's',
            ItemMaterials.DATA.PLATE_EXO.makeStack());
        ...
        addShapedRecipe(
            ItemMaterials.DATA.REINFORCED_PLATE_EXO.makeStack(),
            "sss",
            "sss",
            "sss",
            's',
        ...
        addShapedRecipe(
            new ItemStack(ModItems.reinExoskeletonHelmet, 1),
            "sss",
            "s s",
            's',
            ItemMaterials.DATA.REINFORCED_PLATE_EXO.makeStack());
        addShapedRecipe(
            new ItemStack(ModItems.reinExoskeletonBody, 1),
            "s s",
            "sss",
            "sss",
            's',
            ItemMaterials.DATA.REINFORCED_PLATE_EXO.makeStack());
        addShapedRecipe(
            new ItemStack(ModItems.reinExoskeletonLegs, 1),
            "sss",
            "s s",
            "s s",
            's',
            ItemMaterials.DATA.REINFORCED_PLATE_EXO.makeStack());
        addShapedRecipe(
            new ItemStack(ModItems.reinExoskeletonBoots, 1),
            "s s",
            "s s",
            's',
            ItemMaterials.DATA.REINFORCED_PLATE_EXO.makeStack());
        ...
        // Special armor
        addShapedRecipe(
            ItemMaterials.DATA.COMPOUND_LENS.makeStack(),
            "GGG",
            "GEG",
            "GGG",
            'E',
            new ItemStack(ModBlocks.amber, 1, 1),
            'G',
            ItemMaterials.DATA.COMPOUND_EYES.makeStack());
        addShapedRecipe(
            new ItemStack(ModItems.compoundGoggles, 1),
            "XXX",
            "OXO",
            'O',
            ItemMaterials.DATA.COMPOUND_LENS.makeStack(),
            ...
            ItemMaterials.DATA.PLATE_EXO.makeStack());
        addShapedRecipe(
            new ItemStack(ModItems.reinCompoundGoggles, 1),
            "XXX",
            "XOX",
            'O',
            new ItemStack(ModItems.compoundGoggles, 1),
            ...
            ItemMaterials.DATA.REINFORCED_PLATE_EXO.makeStack());
        addShapedRecipe(
            new ItemStack(ModItems.jumpBoots),
            "F F",
            "BXB",
            "B B",
            'F',
            ...
            'B',
            ItemMaterials.DATA.ELASTIC_FIBRE.makeStack(),
            'X',
            new ItemStack(ModItems.reinExoskeletonBoots, 1));
        addShapedRecipe(
            new ItemStack(ModItems.sprintLeggings),
            "BBB",
            "BXB",
            "BBB",
            'B',
            ItemMaterials.DATA.BIO_VELOCITY.makeStack(),
            'X',
            new ItemStack(ModItems.reinExoskeletonLegs, 1));
        addShapedRecipe(
            new ItemStack(ModItems.armorGlider),
            "GXG",
            'G',
            ItemMaterials.DATA.GLIDER_WING.makeStack(),
            'X',
            new ItemStack(ModItems.reinExoskeletonBody, 1));
        addShapedRecipe(
            new ItemStack(ModItems.armorGliderPowered),
            "W W",
            "ECE",
            " V ",
            'W',
            ItemMaterials.DATA.ENHANCED_GLIDER_WING.makeStack(),
            'E',
            ItemMaterials.DATA.ELASTIC_FIBRE.makeStack(),
            'C',
            new ItemStack(ModItems.armorGlider, 1),
            'V',
            new ItemStack(ModBlocks.velocityBlock, 1));
        GameRegistry.addRecipe(new RecipeGliderDye());
        addShapedRecipe(
            new ItemStack(ModItems.waterStriders),
            "WWW",
            "WXW",
            "WWW",
            'W',
            ItemMaterials.DATA.WATER_REPELLENT.makeStack(),
            'X',
            new ItemStack(ModItems.reinExoskeletonBoots, 1));
        addShapedRecipe(
            new ItemStack(ModItems.rhinoExoskeletonHelmet),
            "h h",
            "sss",
            "s s",
            's',
            ItemMaterials.DATA.PLATE_EXO_RHINO.makeStack(),
            'h',
            ItemMaterials.DATA.RHINO_BEETLE_HORN.makeStack());
        addShapedRecipe(
            new ItemStack(ModItems.rhinoExoskeletonBody),
            "s s",
            "sss",
            "sss",
            's',
            ItemMaterials.DATA.PLATE_EXO_RHINO.makeStack());
        addShapedRecipe(
            new ItemStack(ModItems.rhinoExoskeletonLegs),
            "sss",
            "s s",
            "s s",
            's',
            ItemMaterials.DATA.PLATE_EXO_RHINO.makeStack());
        addShapedRecipe(
            new ItemStack(ModItems.rhinoExoskeletonBoots),
            "s s",
            "s s",
            's',
            ItemMaterials.DATA.PLATE_EXO_RHINO.makeStack());
        ...
        addShapedRecipe(
            new ItemStack(ModItems.scorpionPincer),
            "I I",
            "XIX",
            "XPX",
            'I',
            ...
            ItemMaterials.DATA.REINFORCED_PLATE_EXO.makeStack(),
            'P',
            ItemMaterials.DATA.SCORPION_PINCER.makeStack());
        addShapedRecipe(
            new ItemStack(ModItems.rolledNewspaper),
            "PWP",
            "PIP",
            "PWP",
            'I',
            ...
            'P',
            ItemMaterials.DATA.PAPYRUS.makeStack(),
            'W',
            ItemMaterials.DATA.WHETSTONE_POWDER.makeStack());
        addShapedRecipe(
            ItemMaterials.DATA.GLIDER_WING.makeStack(),
            "SSS",
            "FFF",
        ...
        addShapedRecipe(
            ...
            "WWW",
            'B',
            ItemMaterials.DATA.BAMBOO.makeStack(),
            'W',
            ItemMaterials.DATA.DRAGONFLY_WING.makeStack());
        ...
        addShapedRecipe(
            new ItemStack(ModItems.mushroomHelm, 1),
            "mmm",
            "mpm",
            'm',
            ItemMaterials.DATA.HIDE_SHROOM.makeStack(),
            'p',
            new ItemStack(Blocks.pumpkin));

        addShapedRecipe(
            new ItemStack(ModBlocks.bigBulbCappedMushroom),
            "mmm",
            "mmm",
            "mmm",
            'm',
            new ItemStack(ModBlocks.darkCapped));
        addShapedRecipe(
            new ItemStack(ModBlocks.bigGreenMushroom),
            "mmm",
            "mmm",
            "mmm",
            'm',
            new ItemStack(ModBlocks.grandmasShoes));
        addShapedRecipe(
            new ItemStack(ModBlocks.bigBundleMushroom),
            "mmm",
            "mmm",
            "mmm",
            'm',
            new ItemStack(ModBlocks.sarcasticCzech));
        addShapedRecipe(
            new ItemStack(ModBlocks.bigKaiserfingerMushroom),
            "mmm",
            "mmm",
            "mmm",
            'm',
            new ItemStack(ModBlocks.kaizersFinger));
        addShapedRecipe(
            new ItemStack(ModBlocks.bigDutchCapMushroom),
            "mmm",
            "mmm",
            "mmm",
            'm',
            new ItemStack(ModBlocks.dutchCap));
        addShapedRecipe(
        ...
        addShapedRecipe(
            new ItemStack(ModBlocks.redGem, 1, 1),
            " S ",
            "S#S",
            " S ",
            '#',
            new ItemStack(ModBlocks.redGem, 1, 0),
            'S',
            "stickWood");
        addShapedRecipe(
            new ItemStack(ModBlocks.glowGemBlock, 3, 0),
            "BBB",
            "BGB",
            "BBB",
            'B',
            ItemMaterials.DATA.BIO_LUMINESCENCE.makeStack(),
            'G',
            ItemMaterials.DATA.RED_GEM.makeStack());

        // Bamboo
        addShapedRecipe(
            new ItemStack(ModItems.bambucket, 1, 0),
            " S ",
            "B B",
            " B ",
            'S',
            ...
            ItemMaterials.DATA.BAMBOO.makeStack());
        addShapedRecipe(
            new ItemStack(ModItems.bambucketHoney),
            "RRR",
            "RBR",
            "RRR",
            'B',
            ...
            "dropHoney");
        addShapedRecipe(
            new ItemStack(ModBlocks.planks, 1, EnumWood.Bamboo.ordinal()),
            "##",
            "##",
            '#',
            ItemMaterials.DATA.BAMBOO.makeStack());
        addShapedRecipe(
            new ItemStack(ModBlocks.bambooCrate),
            "bpb",
            "p p",
            "bpb",
            'p',
            ...
            ItemMaterials.DATA.BAMBOO.makeStack());
        addShapedRecipe(
            new ItemStack(ModBlocks.bambooLadder, 1),
            "BBB",
            "S S",
            "BBB",
            'B',
            ...
            Items.string);
        addShapedRecipe(
            new ItemStack(ModBlocks.bambooTorch, 4),
            "C",
            "B",
            "B",
            'C',
            ...
            ItemMaterials.DATA.BAMBOO.makeStack());
        addShapedRecipe(
            new ItemStack(ModBlocks.bambooBridge, 3),
            "SSS",
            "B B",
            "LLL",
            'S',
            ...
            ItemMaterials.DATA.BAMBOO.makeStack());
        addShapedRecipe(
            new ItemStack(ModBlocks.bambooPole, 4),
            "S",
            "B",
            "B",
            'S',
            ...
            ItemMaterials.DATA.BAMBOO.makeStack());
        addShapedRecipe(
            new ItemStack(ModBlocks.extenderThingy, 1),
            "BSB",
            "PDP",
            "BRB",
            'S',
        ...
        addShapelessRecipe(
            new ItemStack(ModItems.food, 1, ItemErebusFood.FoodType.BAMBOO_SOUP.ordinal()),
            new ItemStack(Items.bowl),
            ItemMaterials.DATA.BAMBOO.makeStack(),
            ItemMaterials.DATA.BAMBOO_SHOOT.makeStack());
        addShapelessRecipe(
            new ItemStack(ModItems.food, 1, ItemErebusFood.FoodType.LARVAE_ON_STICK.ordinal()),
            "stickWood",
            new ItemStack(ModItems.food, 1, ItemErebusFood.FoodType.BEETLE_LARVA_COOKED.ordinal()),
            new ItemStack(ModItems.food, 1, ItemErebusFood.FoodType.BEETLE_LARVA_COOKED.ordinal()),
            new ItemStack(ModItems.food, 1, ItemErebusFood.FoodType.BEETLE_LARVA_COOKED.ordinal()));
        addShapedRecipe(
            new ItemStack(ModItems.food, 2, ItemErebusFood.FoodType.HONEY_SANDWICH.ordinal()),
            " B ",
            "RRR",
            " B ",
            'B',
            ...
            "dropHoney");
        addShapedRecipe(
            new ItemStack(ModBlocks.honeyTreat, 1),
            "SRS",
            "RBR",
            "SRS",
            'S',
        ...
        // Miscellaneous
        addShapedRecipe(
            new ItemStack(ModBlocks.mirBrick),
            "xy",
            "yx",
            'x',
            Items.clay_ball,
            'y',
            ItemMaterials.DATA.MUD_BRICK.makeStack());
        addShapedRecipe(
            new ItemStack(ModBlocks.mirBrick),
            "xy",
            "yx",
        ...
        addShapedRecipe(
            ...
            "stickWood",
            'T',
            ItemMaterials.DATA.SHARD_BONE.makeStack());
        addShapedRecipe(
            new ItemStack(Items.arrow, 4),
            "T",
            "S",
        ...
        addShapedRecipe(
            ...
            Items.flint);
        addShapedRecipe(
            new ItemStack(ModItems.sprayCan, 9),
            " B ",
            "XRX",
            "XXX",
            'X',
            ...
            "buttonWood",
            'R',
            ItemMaterials.DATA.REPELLENT.makeStack());
        addShapedRecipe(
            new ItemStack(ModBlocks.altarBase, 1),
            "XXX",
            "XOX",
            "XXX",
            'O',
            Blocks.obsidian,
            'X',
            ItemMaterials.DATA.ALTAR_FRAGMENT.makeStack());
        addShapedRecipe(
            new ItemStack(ModBlocks.glowingJar, 1),
            "XXX",
            "GBG",
            "GGG",
            'X',
            ...
            ItemMaterials.DATA.BIO_LUMINESCENCE.makeStack());
        addShapelessRecipe(
            new ItemStack(ModBlocks.reinExo, 1),
            ItemMaterials.DATA.REINFORCED_PLATE_EXO.makeStack(),
            ItemMaterials.DATA.REINFORCED_PLATE_EXO.makeStack(),
            ItemMaterials.DATA.REINFORCED_PLATE_EXO.makeStack(),
            ItemMaterials.DATA.REINFORCED_PLATE_EXO.makeStack());
        ...
        addShapelessRecipe(
            ...
            ItemMaterials.DATA.PAPYRUS.makeStack());
        addShapedRecipe(
            new ItemStack(ModBlocks.velocityBlock),
            "xxx",
            "xxx",
            "xxx",
            'x',
        ...
        addShapedRecipe(
            new ItemStack(ModItems.homingBeecon),
            "GNG",
            "NCN",
            "GNG",
            'N',
            ItemMaterials.DATA.NECTAR.makeStack(),
            'G',
            "ingotGold",
            'C',
            Items.compass);
        addShapedRecipe(
            new ItemStack(ModItems.nectarCollector),
            "  B",
            " S ",
            "S  ",
            'B',
        ...
        GameRegistry.addRecipe(
            EnchantSensitiveRecipe.makeRecipe(
                new ItemStack(ModItems.blockExtractor),
                "  M",
                " D ",
                "C  ",
                'M',
                ItemMaterials.DATA.STAG_BEETLE_MANDIBLES.makeStack(),
                'D',
                diamondPick,
                'C',
                "chestWood"));
        ...
        addShapedRecipe(
            new ItemStack(ModBlocks.jarOHoney),
            "%%%",
            "$0$",
            "$$$",
            '%',
        ...
        addShapedRecipe(
            ItemMaterials.DATA.MUCUS_CHARGE.makeStack(),
            "SSS",
            "SRS",
            "SSS",
            'S',
            ...
            ItemMaterials.DATA.REPELLENT.makeStack());
        addShapedRecipe(
            new ItemStack(ModBlocks.mucusBomb, 1),
            "MMM",
            "MTM",
            "MMM",
            'M',
            ...
            Blocks.tnt);
        addShapedRecipe(
            new ItemStack(ModBlocks.honeyCombBlock, 1),
            "NPN",
            "PCP",
            "NPN",
            'P',
        ...
        addShapedRecipe(
            ...
            "FFF",
            'F',
            new ItemStack(ModBlocks.fireBloom));
        addShapedRecipe(
            ItemMaterials.DATA.MOSS_BALL.makeStack(),
            "mmm",
            "mmm",
            "mmm",
            'm',
            new ItemStack(ModBlocks.wallPlants, 1, 0));
        addShapelessRecipe(new ItemStack(ModBlocks.scorchedPlanks, 4), ModBlocks.scorchedWood);
        addShapelessRecipe(
            new ItemStack(ModBlocks.glowshroom),
            ItemMaterials.DATA.YELLOW_DOTTED_FUNGUS.makeStack(),
            Blocks.torch);
        addShapelessRecipe(
            new ItemStack(ModBlocks.glowshroom),
            ItemMaterials.DATA.YELLOW_DOTTED_FUNGUS.makeStack(),
            ItemMaterials.DATA.BIO_LUMINESCENCE.makeStack());
        addShapedRecipe(
            new ItemStack(ModItems.portalActivator),
            "VSE",
            "VSS",
            "GVV",
            'V',
            ...
            "stickWood",
            'E',
            ItemMaterials.DATA.GAEAN_GEM.makeStack(),
            'G',
            "ingotGold");
        addShapedRecipe(
            new ItemStack(ModBlocks.gaeanKeystone),
            "V V",
            "SOS",
            "SSS",
            'V',
            ...
            Blocks.obsidian);
        addShapedRecipe(
            new ItemStack(ModItems.antTamingAmulet),
            "pgp",
            "gog",
            "pgp",
            'p',
            ItemMaterials.DATA.ANT_PHEROMONES.makeStack(),
            'g',
            "ingotGold",
            'o',
            Blocks.obsidian);
        addShapelessRecipe(
            new ItemStack(ModItems.planticide, 2),
            ItemMaterials.DATA.POISON_GLAND.makeStack(),
            "slimeball",
            "dyeWhite");
        addShapelessRecipe(
            new ItemStack(ModBlocks.varnishedPlanks),
            "plankWood",
            ItemMaterials.DATA.SAP_BALL.makeStack(),
            ItemMaterials.DATA.REPELLENT.makeStack(),
            ItemMaterials.DATA.CAMO_POWDER.makeStack());
        addShapelessRecipe(
            new ItemStack(ModBlocks.varnishedPlanks),
            "plankWood",
            "slimeball",
            ...
            ItemMaterials.DATA.CAMO_POWDER.makeStack());
        addShapedRecipe(
            new ItemStack(ModBlocks.composter),
            "xyx",
            "xzx",
            "xyx",
            'x',
            ModBlocks.varnishedPlanks,
            'y',
            "dyeGreen",
            'z',
            "gemEmerald");
        ...
        addShapedRecipe(
            new ItemStack(ModBlocks.siloTank),
            "xzx",
            "ywy",
            "xzx",
            'x',
            ...
            ModBlocks.varnishedPlanks,
            'w',
            ModBlocks.petrifiedWoodChest);
        addShapedRecipe(
            new ItemStack(ModBlocks.siloRoof),
            " x ",
            "xyx",
            'x',
            ModBlocks.varnishedPlanks,
            ...
            ModBlocks.petrifiedWoodPlanks);
        addShapedRecipe(
            new ItemStack(ModBlocks.offeringAltar),
            "xwx",
            "yzy",
            "xyx",
            'x',
        ...
        addShapedRecipe(
            ItemMaterials.DATA.JADE.makeStack(),
            "xxx",
            "xxx",
            "xxx",
            'x',
            ItemMaterials.DATA.JADE_BERRIES.makeStack());
        addShapedRecipe(
            ItemMaterials.DATA.WATER_REPELLENT.makeStack(),
            "xxx",
            "xrx",
            "xxx",
            'x',
            ItemMaterials.DATA.HYDROFUGE.makeStack(),
            'r',
            ItemMaterials.DATA.REPELLENT.makeStack());
        addShapelessRecipe(ItemMaterials.DATA.STEW_POT.makeStack(), Items.cauldron, "stickWood");
        addShapelessRecipe(
            ItemMaterials.DATA.TITAN_STEW.makeStack(),
            ItemMaterials.DATA.STEW_POT.makeStack(),
            new ItemStack(ModItems.food, 1, ItemErebusFood.FoodType.TITAN_CHOP_RAW.ordinal()),
            Items.potato,
            Items.carrot,
            new ItemStack(ModItems.food, 1, ItemErebusFood.FoodType.CABBAGE.ordinal()),
            "foodMushroom",
            "foodMushroom");
        addShapelessRecipe(
            ItemMaterials.DATA.TITAN_STEW.makeStack(),
            ...
            "foodMushroom");
        addShapedRecipe(
            new ItemStack(ModBlocks.wallPlantsCultivated, 1, 0),
            "dvd",
            "vpv",
            "dvd",
            'd',
            ...
            'v',
            ItemMaterials.DATA.SUPERNATURAL_VELOCITY.makeStack(),
            'p',
            new ItemStack(ModBlocks.wallPlants, 1, 0));
        addShapedRecipe(
            new ItemStack(ModBlocks.wallPlantsCultivated, 1, 1),
            "dvd",
            "vpv",
            "dvd",
            'd',
            ...
            ItemMaterials.DATA.SUPERNATURAL_VELOCITY.makeStack(),
            'p',
            new ItemStack(ModBlocks.wallPlants, 1, 1));
        ...
        addShapedRecipe(
            ...
            "xx",
            'x',
            new ItemStack(ModBlocks.erebusFlower, 1, FLOWER_TYPE.STEM.ordinal()));
        addShapedRecipe(
            ItemMaterials.DATA.AMBER_STAR.makeStack(),
            " x ",
            "xyx",
            " x ",
            'x',
        ...
        addShapedRecipe(
            ...
            "xx",
            'x',
            ItemMaterials.DATA.PLATE_ZOMBIE_ANT.makeStack());

        // Smoothies
        // Have to figure this out...
        addShapelessRecipe(
            ItemMaterials.DATA.SMOOTHIE_GLASS.makeStack(),
            Items.glass_bottle,
            Items.glass_bottle,
            Items.glass_bottle);
        addShapedRecipe(
            new ItemStack(ModBlocks.smoothieMaker),
            "xrx",
            "xxx",
            "sss",
            'x',
            ItemMaterials.DATA.SMOOTHIE_GLASS.makeStack(),
            'r',
            new ItemStack(ModBlocks.redGem),
            's',
            new ItemStack(ModBlocks.umberstone));

        addShapelessRecipe(
            new ItemStack(ModItems.bottleAntiVenom, 2),
            ModItems.bucketAntiVenom,
            Items.glass_bottle,
            Items.glass_bottle);
        addShapelessRecipe(
            new ItemStack(ModItems.bottleAntiVenom, 2),
            ModItems.bambucketAntiVenom,
            Items.glass_bottle,
            Items.glass_bottle);

        // Whetstone
        addShapedRecipe(
            new ItemStack(ModItems.whetstone, 1, 0),
            "SSS",
            "PPP",
            "UUU",
            'S',
            ...
            ItemMaterials.DATA.PETRIFIED_WOOD.makeStack(),
            'U',
            new ItemStack(ModBlocks.umberstone, 1, 0));
        for (int i = 1; i <= Enchantment.sharpness.getMaxLevel(); i++) addShapedRecipe(
            new ItemStack(ModItems.whetstone, 1, i),
            "xxx",
            "xyx",
            "xxx",
            'x',
            ItemMaterials.DATA.WHETSTONE_POWDER.makeStack(),
            'y',
            new ItemStack(ModItems.whetstone, 1, i - 1));

        // Special Items
        addShapedRecipe(
            ItemMaterials.DATA.RHINO_RIDING_KIT.makeStack(),
            " SX",
            "CCC",
            "LLL",
            'S',
            ...
            new ItemStack(Items.dye, 1, 4));
        addShapedRecipe(
            ItemMaterials.DATA.BEETLE_TAMING_AMULET.makeStack(),
            " N ",
            "NJN",
            " F ",
            'N',
            ...
            ItemMaterials.DATA.ALTAR_FRAGMENT.makeStack());
        addShapedRecipe(
            new ItemStack(ModItems.beeTamingAmulet),
            " n ",
            "nJn",
            " N ",
            'n',
        ...
        // Umbergolem parts
        addShapedRecipe(
            ItemMaterials.DATA.UMBERGOLEM_CORE.makeStack(),
            "AAA",
            "ARA",
            "AAA",
            'A',
        ...
        addShapedRecipe(
            ...
            ItemMaterials.DATA.STAG_BEETLE_MANDIBLES.makeStack());
        addShapedRecipe(
            ItemMaterials.DATA.UMBERGOLEM_CLAW.makeStack(),
            "  P",
            "  S",
            " SS",
            'S',
        ...
        addShapedRecipe(
            ...
            ItemMaterials.DATA.SCORPION_PINCER.makeStack());
        addShapedRecipe(
            ItemMaterials.DATA.UMBERGOLEM_LEGS.makeStack(),
            "SSS",
            "S S",
            "R R",
            'S',
            ...
            ItemMaterials.DATA.REINFORCED_PLATE_EXO.makeStack());
        addShapedRecipe(
            ItemDungeonIdols.IDOL.MUD_UMBERGOLEM.makeStack(),
            "XXX",
            "XUX",
            "XXX",
            'X',
            ModBlocks.mudBricks,
            'U',
            ModBlocks.umberGolemStatue);
        addShapedRecipe(
            ItemDungeonIdols.IDOL.IRON_UMBERGOLEM.makeStack(),
            "XXX",
            "XUX",
            "XXX",
            'X',
            ...
            ModBlocks.umberGolemStatue);
        addShapedRecipe(
            ItemDungeonIdols.IDOL.GOLD_UMBERGOLEM.makeStack(),
            "XXX",
            "XUX",
            "XXX",
            'X',
            ...
            ModBlocks.umberGolemStatue);
        addShapedRecipe(
            ItemDungeonIdols.IDOL.JADE_UMBERGOLEM.makeStack(),
            "XXX",
            "XUX",
            "XXX",
            'X',
        ...
        // Umbergolem Statue
        addShapedRecipe(
            new ItemStack(ModBlocks.umberGolemStatue),
            " H ",
            "LCL",
            " X ",
            'H',
        ...
        // Animation Magic
        addShapedRecipe(
            new ItemStack(ModItems.wandOfAnimation),
            " xy",
            " zx",
            "x  ",
            'x',
            "ingotGold",
            'y',
            ItemMaterials.DATA.SOUL_CRYSTAL.makeStack(),
            'z',
            "stickWood");

        // Temporary Replacement Recipes
        addShapelessRecipe(
            new ItemStack(ModItems.witherWebSlinger),
            new ItemStack(ModItems.webSlinger),
            new ItemStack(Blocks.soul_sand),
            ItemMaterials.DATA.POISON_GLAND.makeStack(),
            new ItemStack(ModBlocks.witherWeb),
            new ItemStack(ModBlocks.witherWeb),
            new ItemStack(ModBlocks.witherWeb));
        addShapelessRecipe(
            new ItemStack(ModBlocks.lightningSpeedBlock),
            new ItemStack(ModBlocks.velocityBlock),
            ItemMaterials.DATA.SUPERNATURAL_VELOCITY.makeStack(),
            ItemMaterials.DATA.SUPERNATURAL_VELOCITY.makeStack(),
            ItemMaterials.DATA.SUPERNATURAL_VELOCITY.makeStack(),
    ...
    private static void registerSmelting() {
        ...
        GameRegistry.addSmelting(
            new ItemStack(ModItems.food, 1, ItemErebusFood.FoodType.BEETLE_LARVA_RAW.ordinal()),
            new ItemStack(ModItems.food, 1, ItemErebusFood.FoodType.BEETLE_LARVA_COOKED.ordinal()),
            0.2F);
        GameRegistry.addSmelting(
            new ItemStack(ModItems.food, 1, ItemErebusFood.FoodType.GRASSHOPPER_LEG_RAW.ordinal()),
            new ItemStack(ModItems.food, 1, ItemErebusFood.FoodType.GRASSHOPPER_LEG_COOKED.ordinal()),
            0.2F);
        GameRegistry.addSmelting(
            new ItemStack(ModItems.food, 1, ItemErebusFood.FoodType.TARANTULA_LEG_RAW.ordinal()),
            new ItemStack(ModItems.food, 1, ItemErebusFood.FoodType.TARANTULA_LEG_COOKED.ordinal()),
            0.2F);
        GameRegistry.addSmelting(
            new ItemStack(ModItems.food, 1, ItemErebusFood.FoodType.TITAN_CHOP_RAW.ordinal()),
            new ItemStack(ModItems.food, 1, ItemErebusFood.FoodType.TITAN_CHOP_COOKED.ordinal()),
            0.2F);
        GameRegistry.addSmelting(
            new ItemStack(ModItems.food, 1, ItemErebusFood.FoodType.PRICKLY_PAIR_RAW.ordinal()),
            new ItemStack(ModItems.food, 1, ItemErebusFood.FoodType.PRICKLY_PAIR_COOKED.ordinal()),
            0.2F);
        ...
        GameRegistry.addSmelting(
            new ItemStack(ModBlocks.orePetrifiedWood),
            ItemMaterials.DATA.PETRIFIED_WOOD.makeStack(),
            0.1F);
        GameRegistry
            .addSmelting(new ItemStack(ModBlocks.oreEncrustedDiamond), new ItemStack(ModItems.encrustedDiamond), 1.0F);
        GameRegistry.addSmelting(
            ItemMaterials.DATA.TITAN_STEW.makeStack(),
            new ItemStack(ModItems.food, 1, ItemErebusFood.FoodType.TITAN_STEW_COOKED.ordinal()),
            1.0F);
        ...
        GameRegistry
            .addSmelting(ItemMaterials.DATA.NECTAR.makeStack(), ItemMaterials.DATA.HONEY_DRIP.makeStack(), 0.2F);
        ...
        if (OreType.SILVER.isEnabled()) GameRegistry
            .addSmelting(new ItemStack(ModBlocks.oreSilver), ItemMaterials.DATA.INGOT_SILVER.makeStack(), 1.0F);
        if (OreType.COPPER.isEnabled()) GameRegistry
            .addSmelting(new ItemStack(ModBlocks.oreCopper), ItemMaterials.DATA.INGOT_COPPER.makeStack(), 1.0F);
        ...
        if (OreType.ALUMINIUM.isEnabled()) GameRegistry
            .addSmelting(new ItemStack(ModBlocks.oreAluminium), ItemMaterials.DATA.INGOT_ALUMINIUM.makeStack(), 1.0F);
    }
    ...
    private static void registerOreDictionary() {
        ...
        OreDictionary
            .registerOre("dyeBlack", new ItemStack(ModBlocks.erebusFlower, 1, FLOWER_TYPE.BLACK_PETAL.ordinal()));
        OreDictionary.registerOre("dyeRed", new ItemStack(ModBlocks.erebusFlower, 1, FLOWER_TYPE.RED_PETAL.ordinal()));
        OreDictionary
            .registerOre("dyeBrown", new ItemStack(ModBlocks.erebusFlower, 1, FLOWER_TYPE.BROWN_PETAL.ordinal()));
        OreDictionary
            .registerOre("dyeBlue", new ItemStack(ModBlocks.erebusFlower, 1, FLOWER_TYPE.BLUE_PETAL.ordinal()));
        OreDictionary
            .registerOre("dyePurple", new ItemStack(ModBlocks.erebusFlower, 1, FLOWER_TYPE.PURPLE_PETAL.ordinal()));
        OreDictionary
            .registerOre("dyeCyan", new ItemStack(ModBlocks.erebusFlower, 1, FLOWER_TYPE.CYAN_PETAL.ordinal()));
        OreDictionary.registerOre(
            "dyeLightGray",
            new ItemStack(ModBlocks.erebusFlower, 1, FLOWER_TYPE.LIGHT_GRAY_PETAL.ordinal()));
        OreDictionary
            .registerOre("dyeGray", new ItemStack(ModBlocks.erebusFlower, 1, FLOWER_TYPE.GRAY_PETAL.ordinal()));
        OreDictionary
            .registerOre("dyePink", new ItemStack(ModBlocks.erebusFlower, 1, FLOWER_TYPE.PINK_PETAL.ordinal()));
        OreDictionary
            .registerOre("dyeYellow", new ItemStack(ModBlocks.erebusFlower, 1, FLOWER_TYPE.YELLOW_PETAL.ordinal()));
        OreDictionary.registerOre(
            "dyeLightBlue",
            new ItemStack(ModBlocks.erebusFlower, 1, FLOWER_TYPE.LIGHT_BLUE_PETAL.ordinal()));
        OreDictionary
            .registerOre("dyeMagenta", new ItemStack(ModBlocks.erebusFlower, 1, FLOWER_TYPE.MAGENTA_PETAL.ordinal()));
        OreDictionary
            .registerOre("dyeOrange", new ItemStack(ModBlocks.erebusFlower, 1, FLOWER_TYPE.ORANGE_PETAL.ordinal()));
        OreDictionary
            .registerOre("dyeWhite", new ItemStack(ModBlocks.erebusFlower, 1, FLOWER_TYPE.WHITE_PETAL.ordinal()));
