...
public class ModBlocks {
    ...
    public static final Block volcanicRock = new BlockSimple(Material.rock).setHardness(5.0F)
        .setResistance(20.0F)
        .setStepSound(Block.soundTypeStone)
        .setBlockName("erebus.volcanicRock")
        .setBlockTextureName("erebus:volcanicRock");
    ...
    public static final Block erebusFlower = new BlockErebusFlower().setHardness(1.0F)
        .setStepSound(Block.soundTypeGrass)
        .setBlockName("erebus.flower");
    public static final Block stiga = new BlockErebusStigma().setHardness(1.0F)
        .setStepSound(Block.soundTypeGrass)
        .setBlockName("erebus.stigma");
    public static final Block scorchedWood = new BlockSimple(Material.wood).setHardness(2.0F)
        .setStepSound(Block.soundTypeWood)
        .setCreativeTab(ModTabs.blocks)
        .setBlockName("erebus.log_scorched")
        .setBlockTextureName("erebus:log_scorched");
    public static final Block scorchedPlanks = new BlockSimple(Material.wood).setHardness(2.0F)
        .setResistance(5.0F)
        .setStepSound(Block.soundTypeWood)
        .setCreativeTab(ModTabs.blocks)
        .setBlockName("erebus.planks_scorched")
        .setBlockTextureName("erebus:planks_scorched");
    public static final Block varnishedPlanks = new BlockSimple(Material.wood).setHardness(2.0F)
        .setStepSound(Block.soundTypeWood)
        .setCreativeTab(ModTabs.blocks)
        .setBlockName("erebus.planks_varnished")
        .setBlockTextureName("erebus:planks_varnished");
    ...
    public static final Block mireCoral = new BlockMireCoral().setHardness(0.2F)
        .setStepSound(Block.soundTypeGrass)
        .setBlockName("erebus.mireCoral")
        .setBlockTextureName("erebus:swampGlowWeed")
        .setLightLevel(0.8F);
    public static final Block algae = new BlockAlgae().setBlockName("erebus.algae")
        .setBlockTextureName("erebus:algae");
    public static final Block blockCabbage = new BlockCabbage();
    public static final Block giantLilyPad = new BlockSimple(Material.wood, "axe", 1).setHardness(5.0F)
        .setStepSound(Block.soundTypeGrass)
        .setBlockName("erebus.giantLilyPad")
        .setBlockTextureName("erebus:giantLilyPad")
        .setCreativeTab(ModTabs.blocks);
    public static final Block pricklyPair = new BlockPricklyPair();

    // DECORATIONS AND UTILITIES
    public static final Block blockSilk = new BlockSimple(Material.cloth).setHardness(0.2F)
        .setStepSound(Block.soundTypeCloth)
        .setBlockName("erebus.blockSilk")
        .setBlockTextureName("erebus:blockSilk")
        .setCreativeTab(ModTabs.blocks);
    public static final Block mirBrick = new BlockSimple(Material.rock, "pickaxe", 1).setHardness(1.5F)
        .setStepSound(Block.soundTypeStone)
        .setBlockName("erebus.mirbrick")
        .setBlockTextureName("erebus:mirbrick")
        .setCreativeTab(ModTabs.blocks);
    public static final Block petrifiedWoodPlanks = new BlockSimple(Material.rock).setHardness(2.0F)
        .setStepSound(Block.soundTypeWood)
        .setBlockName("erebus.petrifiedWoodPlanks")
    ...
    public static final Block bambooCrop = new BlockBambooCrop().setHardness(1.0F)
        .setStepSound(Block.soundTypeWood)
        .setBlockName("erebus.bambooCrop")
        .setBlockTextureName("erebus:bambooCropBase");
    public static final Block bambooTorch = new BlockBambooTorch();
    public static final Block glowingJar = new BlockGlowingJar();
    public static final Block reinExo = new BlockSimple(Material.rock).setHardness(1.5F)
        .setResistance(2000.0F)
        .setStepSound(Block.soundTypeStone)
        .setBlockName("erebus.reinExo")
        .setBlockTextureName("erebus:blockReinExo")
        .setCreativeTab(ModTabs.blocks);
    ...
    public static final Block mudBricks = new BlockSimple(Material.rock).setBlockName("erebus.mudBricks")
        .setBlockTextureName("erebus:mudBricks")
        .setHardness(0.8F)
        .setResistance(1.0F)
        .setCreativeTab(ModTabs.blocks);
    public static final Block jarOHoney = new JarOHoney();
    public static final Block jadeBlock = new BlockCompressed(MapColor.greenColor).setHardness(5.0F)
        .setResistance(10.0F)
        .setStepSound(Block.soundTypeMetal)
        .setBlockName("erebus.blockJade")
        .setBlockTextureName("erebus:blockJade")
        .setCreativeTab(ModTabs.blocks);
    public static final Block glowGemBlock = new BlockGlowGem();
    public static final Block mucusBomb = new BlockMucusBomb();
    public static final Block siloSupports = new BlockSiloSupports(Material.wood).setHardness(2F)
        .setStepSound(Block.soundTypeWood)
        .setBlockName("erebus.siloSupports")
        .setBlockTextureName("erebus:siloSupports");
    public static final Block siloTank = new BlockSiloTank(Material.iron).setHardness(3F)
        .setStepSound(Block.soundTypeMetal)
        .setBlockName("erebus.siloTank");
    public static final Block siloRoof = new BlockSiloRoof(Material.iron).setHardness(3F)
        .setStepSound(Block.soundTypeMetal)
        .setBlockName("erebus.siloRoof")
        .setBlockTextureName("erebus:siloRoof");
    public static final Block composter = new BlockComposter().setHardness(3.5F)
        .setStepSound(Block.soundTypeStone)
        .setBlockName("erebus.composter");
    ...
    // DUNGEONS
    public static final Block spiderSpawner = new BlockSpiderSpawner("scytodes").setBlockName("erebus.spiderSpawner")
        .setBlockTextureName("erebus:spiderSpawner");
    public static final Block jumpingSpiderSpawner = new BlockSpiderSpawner("jumpingSpider")
        .setBlockName("erebus.jumpingSpiderSpawner")
        .setBlockTextureName("erebus:spiderSpawner");
    public static final Block tarantulaSpawner = new BlockSpiderSpawner("tarantula")
        .setBlockName("erebus.tarantulaSpawner")
        .setBlockTextureName("erebus:spiderSpawner");
    public static final Block waspSpawner = new BlockWaspSpawner("wasp").setBlockName("erebus.waspSpawner")
        .setBlockTextureName("erebus:waspNestSpawner");
    public static final Block antlionSpawner = new BlockAntlionSpawner("antlion").setBlockName("erebus.antlionSpawner")
        .setBlockTextureName("erebus:spiderSpawner");
    public static final Block magmaCrawlerSpawner = new BlockMagmaCrawlerSpawner("magmaCrawler")
        .setBlockName("erebus.magmaCrawlerSpawner")
        .setBlockTextureName("erebus:spiderSpawner");
    public static final Block dragonflySpawner = new BlockDragonflySpawner("dragonfly")
        .setBlockName("erebus.dragonflySpawner")
        .setBlockTextureName("erebus:spiderSpawner");
    ...
    public static final Block zombieAntSpawner = new BlockZombieAntSpawner("zombieAnt")
        .setBlockName("erebus.zombieAntSpawner")
        .setBlockTextureName("erebus:ant_spawner");
    public static final Block zombieAntSoldierSpawner = new BlockZombieAntSpawner("zombieAntSoldier")
        .setBlockName("erebus.zombieAntSoldierSpawner")
        .setBlockTextureName("erebus:ant_spawner");
    ...
    public static final Block templeBrick = new BlockSimple(Material.rock).setHardness(2.0F)
        .setStepSound(Block.soundTypeStone)
        .setBlockName("erebus.templeBrick")
        .setBlockTextureName("erebus:templeBrick");
    public static final Block templePillar = new BlockSimple(Material.rock).setHardness(2.0F)
        .setStepSound(Block.soundTypeStone)
        .setBlockName("erebus.templePillar")
        .setBlockTextureName("erebus:templePillar");
    public static final Block templeTile = new BlockSimple(Material.rock).setHardness(2.0F)
        .setStepSound(Block.soundTypeStone)
        .setBlockName("erebus.templeTile")
        .setBlockTextureName("erebus:templeTile");
    ...
    public static final Block petrifiedWoodStairs = new BlockStairsBase(petrifiedWoodPlanks, 0)
        .setBlockName("erebus.petrifiedWoodStairs");
    public static final Block amberBrickStairs = new BlockStairsBase(amber, 2).setBlockName("erebus.amberBrickStairs");
    public static final Block waspNestStairs = new BlockStairsBase(waspNestBlock, 2).setHardness(50.0F)
        .setBlockName("erebus.waspNestStairs");
    public static final Block anthillStairs = new BlockStairsBase(anthillBlock, 0).setBlockUnbreakable()
        .setBlockName("erebus.anthillStairs");
    ...
    private static void registerBlock(Block block) {
        ...
        if (block instanceof IHasCustomItemBlock) GameRegistry
            .registerBlock(block, ((IHasCustomItemBlock) block).getItemBlockClass(), strings[strings.length - 1]);
