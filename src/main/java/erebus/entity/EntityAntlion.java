...
public class EntityAntlion extends EntityMob {
    ...
    protected void applyEntityAttributes() {
        ...
        getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(
            ConfigHandler.INSTANCE.mobHealthMultipier < 2 ? 35D : 35D * ConfigHandler.INSTANCE.mobHealthMultipier);
    ...
    public boolean getCanSpawnHere() {
        return isOnSand() && super.getCanSpawnHere() || isOnGneiss() && super.getCanSpawnHere()
            || isOnSpawner() && super.getCanSpawnHere();
    }
    ...
    public boolean isOnSpawner() {
        return worldObj.getBlock(
            ...
            MathHelper.floor_double(posZ)) == ModBlocks.antlionSpawner;
    }
    ...
    public boolean isOnSand() {
        return worldObj.getBlock(
            MathHelper.floor_double(posX),
            MathHelper.floor_double(boundingBox.minY) - 1,
            MathHelper.floor_double(posZ)) == Blocks.sand;
    }
    ...
    public void onUpdate() {
        ...
        if (!worldObj.isRemote && getEntityToAttack() == null && isOnSand()) yOffset = -1;
        else yOffset = 0;
    }
