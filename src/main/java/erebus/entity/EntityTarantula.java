...
public class EntityTarantula extends EntityMob {
    ...
    protected void applyEntityAttributes() {
        ...
        getEntityAttribute(SharedMonsterAttributes.attackDamage).setBaseValue(
            ConfigHandler.INSTANCE.mobAttackDamageMultiplier < 2 ? 5D
                : 5D * ConfigHandler.INSTANCE.mobAttackDamageMultiplier);
    ...
    protected void dropFewItems(boolean recentlyHit, int looting) {
        ...
        if (isBurning()) entityDropItem(new ItemStack(ModItems.food, legDrop + looting, 5), 0.0F);
        else entityDropItem(new ItemStack(ModItems.food, legDrop + looting, 4), 0.0F);
