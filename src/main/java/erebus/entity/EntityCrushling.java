...
public class EntityCrushling extends EntityAnimal {
    ...
    public void onLivingUpdate() {
        ...
        if (rand.nextInt(200) == 0) {
            ...
            if (worldObj.isAirBlock(x, y, z) && worldObj.getBiomeGenForCoords(x, z).biomeID == ModBiomes.fungalForestID
                && Blocks.brown_mushroom.canPlaceBlockAt(worldObj, x, y, z)) {
                int mush = rand.nextInt(3);
                if (mush != 0) worldObj.setBlock(x, y, z, Blocks.brown_mushroom);
                else worldObj.setBlock(
                    x,
                    y,
                    z,
                    BiomeDecoratorFungalForest.mushrooms[rand.nextInt(BiomeDecoratorFungalForest.mushrooms.length)],
                    0,
                    3);
            }
        }
