...
public class EntityUmberGolem extends EntityCreature {
    ...
    protected void applyEntityAttributes() {
        ...
        getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(
            ConfigHandler.INSTANCE.mobHealthMultipier < 2 ? 75D : 75D * ConfigHandler.INSTANCE.mobHealthMultipier);
    ...
    protected boolean Attack(Entity entity) {
        if (!worldObj.isRemote) {
            ...
            entity.attackEntityFrom(
                ...
                (float) (ConfigHandler.INSTANCE.mobAttackDamageMultiplier < 2 ? 5D
    ...
    public boolean interact(EntityPlayer player) {
        ...
        if (!worldObj.isRemote && is != null && is.getItem() == ModItems.wandOfAnimation) {
            ...
            worldObj.setBlock(
                ...
                MathHelper.floor_double(posY + 0.1D),
