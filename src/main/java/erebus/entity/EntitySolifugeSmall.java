...
public class EntitySolifugeSmall extends EntityMob implements IEntityAdditionalSpawnData {
    ...
    public final String[] potionName = new String[] { "Move Slowdown", "Dig Slowdown", "Confusion", "Blindness",
    ...
    protected void applyEntityAttributes() {
        ...
        getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(
            ConfigHandler.INSTANCE.mobHealthMultipier < 2 ? 10D : 10D * ConfigHandler.INSTANCE.mobHealthMultipier);
    ...
    public boolean attackEntityAsMob(Entity entity) {
        if (super.attackEntityAsMob(entity)) {
            if (entity instanceof EntityLivingBase) {
                ...
                if (duration > 0) ((EntityLivingBase) entity).addPotionEffect(
                    new PotionEffect(Potion.potionTypes[potionIds[getPotionEffect()]].id, duration * 20, 0));
            }
            return true;
        } else return false;
    }
