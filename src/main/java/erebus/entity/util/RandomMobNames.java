...
public final class RandomMobNames {
    ...
    static {
        ...
        names.put(
            EntityBeetle.class,
            new NameData(280, new String[] { "John Lennon", "Paul McCartney", "George Harisson", "Ringo Starr" }));
    ...
    public void onLivingSpawn(LivingSpawnEvent e) {
        ...
        if (data != null && entity.getRNG()
            .nextInt(data.diceSides) == 0 && !entity.hasCustomNameTag())
            entity.setCustomNameTag(
                data.nameList[entity.getRNG()
                    .nextInt(data.nameList.length)]);
    }
