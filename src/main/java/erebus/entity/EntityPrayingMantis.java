...
public class EntityPrayingMantis extends EntityMob {
    ...
    public void onUpdate() {
        if (!worldObj.isRemote && getAttackTarget() != null) {
            ...
            if (d1 >= 4.0D) dataWatcher.updateObject(20, (24.0F - (float) d1) * 0.0208333F);
            if (d1 < 4.0D) dataWatcher.updateObject(20, (24.0F - (float) d1) * 0.041666F);
        }
        ...
        if (!worldObj.isRemote) {
            ...
            if (attackAnimation == 5) setAttackAnimation(0, (byte) 1);
