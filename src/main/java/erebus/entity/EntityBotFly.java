...
public class EntityBotFly extends EntityMob {
    ...
    public void setIsFlyHanging(boolean par1) {
        ...
        if (par1) dataWatcher.updateObject(16, Byte.valueOf((byte) (duration | 1)));
        else dataWatcher.updateObject(16, Byte.valueOf((byte) (duration & -2)));
    }
    ...
    protected void dropFewItems(boolean recentlyHit, int looting) {
        ...
        for (amount = 0; amount < chance; ++amount) {
            ...
            if (rand.nextInt(5) == 0) entityDropItem(ItemMaterials.DATA.COMPOUND_EYES.makeStack(), 0.0F);
        }
    }
    ...
    public boolean attackEntityAsMob(Entity entity) {
        if (super.attackEntityAsMob(entity)) {
            if (entity instanceof EntityPlayer) if (rand.nextInt(20) == 0 && entity.riddenByEntity == null) {
            ...
            } else if (rand.nextInt(20) == 0 && entity.riddenByEntity != null
                && entity.riddenByEntity instanceof EntityBotFlyLarva)
                if (((EntityBotFlyLarva) entity.riddenByEntity).getParasiteCount() < 3)
                    ((EntityBotFlyLarva) entity.riddenByEntity)
                        .setParasiteCount((byte) (((EntityBotFlyLarva) entity.riddenByEntity).getParasiteCount() + 1));
            return true;
        }
        return false;
    }
