...
public class EntityLeech extends EntityMob {
    ...
    public void onCollideWithPlayer(EntityPlayer player) {
        ...
        if (!worldObj.isRemote && !player.capabilities.isCreativeMode)
            if (player.riddenByEntity == null && getBloodConsumed() <= 0) mountEntity(player);
    }
    ...
    public void onUpdate() {
        ...
        if (hungerCoolDown > 0) if (--hungerCoolDown == 0) setBloodConsumed(0);
        ...
        if (getBloodConsumed() == 5 && ridingEntity != null) mountEntity(null);
