...
public class EntityStagBeetle extends EntityTameable {
    ...
    protected void dropFewItems(boolean recentlyHit, int looting) {
        ...
        if (rareDropChance == 0) entityDropItem(ItemMaterials.DATA.STAG_BEETLE_MANDIBLES.makeStack(), 0.0F);
        if (rareDropChance >= 1 && rareDropChance <= 4) {
            if (isBurning()) entityDropItem(new ItemStack(ModItems.stagHeartCooked), 1);
            else entityDropItem(new ItemStack(ModItems.stagHeartRaw), 1);
        }
    }
