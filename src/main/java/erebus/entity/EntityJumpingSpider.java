...
public class EntityJumpingSpider extends EntitySpider {
    ...
    protected void attackEntity(Entity entity, float distance) {
        ...
        if (distance > 2.0F && distance < 12.0F && rand.nextInt(10) == 0) if (onGround) {
    ...
    protected void dropFewItems(boolean recentlyHit, int looting) {
        ...
        int amount;
        for (amount = 0; amount < chance; ++amount) entityDropItem(ItemMaterials.DATA.POISON_GLAND.makeStack(), 0F);
    }
