...
public class NEIErebusConfig implements IConfigureNEI {
    ...
    public void loadConfig() {
        ...
        ModBlocks.BLOCKS.forEach(block -> {if (block instanceof BlockDoorErebus) API.hideItem(new ItemStack(block));});

        ModBlocks.BLOCKS.clear(); // this entire arraylist only is used once, just delete it
    }
